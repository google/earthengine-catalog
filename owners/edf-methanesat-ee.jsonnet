{
  ...
  "description": "This growing public preview is derived from data collected by [MethaneSAT](https://www.methanesat.org/) and [MethaneAIR](https://www.methanesat.org/project-updates/meet-methaneair) after May 2024. Launched into orbit on March 4th, 2024, [MethaneSAT](https://www.methanesat.org/) is the first satellite developed and funded by an environmental nonprofit organization. It is the only methane-detecting satellite that sees the whole picture, measuring methane emissions from millions of small sources around the world that are a huge part of the problem.
