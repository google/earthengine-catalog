...
It has one purpose — to speed up reductions in methane emissions as quickly as possible, so we can slow down global warming. MethaneSAT data are publicly accessible so that companies, governments and advocates can speed up emissions cuts, track progress and hold polluters truly accountable. MethaneSAT LLC is a wholly owned subsidiary of Environmental Defense Fund.
",
