...
raw observations and a GLT need to project the data onto a north-up WGS84 grid.
Those GLTs were used to evaluate the geocorrect module written to generate GLTs
for datasets that only have raw observations.
...
def generate_haversine_tif(
  ...
  print('Histo:', numpy.histogram(valid_hav, bins=16))
...
def main(argv: Sequence[str]) -> None:
  ...
  index = geocorrect.CoordinateIndex.from_arrays(
      lat, lon, lat_fillvalue=lat.fillvalue, lon_fillvalue=lon.fillvalue
  )
