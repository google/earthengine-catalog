...
COLLECTION_EXCEPTION_IDS = frozenset({
    ...
    'OpenET/ENSEMBLE/CONUS/GRIDMET_MONTHLY/v2_0',
    'OpenET/DISALEXI/CONUS/GRIDMET_MONTHLY/v2_0',
    'OpenET/EEMETRIC/CONUS/GRIDMET_MONTHLY/v2_0',
    'OpenET/GEESEBAL/CONUS/GRIDMET_MONTHLY/v2_0',
