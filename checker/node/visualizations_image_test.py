...
class ErrorVisualizationsImageTest(test_utils.NodeTest):
  ...
  def test_bias_not_list(self):
    self.assert_collection(
        ...
        'eo:bands': [{'name': 'B1'}], 'gee:visualizations': [{
            'image_visualization': {'band_vis': {
                'bands': ['B1'], 'min': [1], 'bias': 'not a list'}}}]}}, 'bias must be a list')
  ...
  def test_bias_empty_list(self):
    self.assert_collection(
        ...
        'eo:bands': [{'name': 'B1'}], 'gee:visualizations': [{
            'image_visualization': {'band_vis': {
                'bands': ['B1'], 'min': [1], 'bias': []}}}]}}, 'bias must be length 1')
  ...
  def test_bias_not_number(self):
    self.assert_collection(
        ...
        'eo:bands': [{'name': 'B1'}], 'gee:visualizations': [{
            'image_visualization': {'band_vis': {
                'bands': ['B1'], 'min': [1], 'bias': ['not a number']}}}]}}, 'bias value must be a number')
    ...
    self.assert_collection(
        ...
        'gee:visualizations': [{
            'image_visualization': {'band_vis': {
                'bands': ['B1', 'B2', 'B3'],
                'min': [1, 2, 3],
                'palette': ['000088', 'ffffff']}}}]}}, 'palette can only have one band')
