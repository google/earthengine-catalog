...

{
  ...
  links: [
    ...
    ee.link.child_collection('projects_forestdatapartnership_assets_palm_model_2026a', base_url),
    ee.link.child_collection('projects_forestdatapartnership_assets_rubber_model_2026a', base_url),
    ee.link.child_collection('projects_forestdatapartnership_assets_cocoa_model_2026a', base_url),
    ee.link.child_collection('projects_forestdatapartnership_assets_coffee_model_2026a', base_url),
