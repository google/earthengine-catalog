local id = 'projects/forestdatapartnership/assets/rubber/model_2026a';
...

{
  ...
  id: id,
  version: version,
  title: 'Rubber Probability model ' + version,
  ...
  description: |||
    ...
    Please see this
    [GitHub README](https://github.com/google/forest-data-partnership/tree/main/models/model_2026a)
  ...
  extent: ee.extent(-180.0, -24.0, 180.0, 24.0, '2018-01-01T00:00:00Z', '2024-12-31T23:59:59Z'),
  summaries: {
    'eo:bands': [
      {
        name: 'probability',
    ...
    'gee:visualizations': [
      ...
      {
        display_name: 'Predicted probability of rubber presence',
        lookat: { lon: -7, lat: 7, zoom: 6 },
        image_visualization: { band_vis: { min: [0.38], bands: ['probability'] } },
      },
    ],
  },
  'sci:citation': |||
    Forest Data Partnership. 2026. Community models 2026a. [Online](https://github.com/google/forest-data-partnership/tree/main/models/model_2026a/README.md)
  |||,
  'gee:terms_of_use': |||
