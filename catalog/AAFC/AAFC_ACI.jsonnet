    ...
    'eo:bands': [
      {
        ...
        'gee:classes': [
          ...
          {value: 60, color: '666666', description: 'Forest Fire and Burnt Area'},
          ...
          {value: 121, color: 'ff9933', description: 'Cropland'},
          ...
          {value: 134, color: '99cc00', description: 'Other Grains'},
          {value: 135, color: 'd2db25', description: 'Millet'},
          {value: 136, color: 'd1d52b', description: 'Oats'},
          {value: 137, color: 'cacd32', description: 'Rye'},
          ...
          {value: 145, color: '809769', description: 'Winter Wheat'},
          {value: 146, color: '92a55b', description: 'Spring Wheat'},
          {value: 147, color: 'ffff99', description: 'Corn for Grain'},
          ...
          {value: 159, color: '5ea296', description: 'Other Oilseeds'},
          ...
          {value: 185, color: 'dc3200', description: 'Other Berries'},
          ...
          {value: 191, color: 'ffcc99', description: 'Hops'},
    ...
    'gee:visualizations': [{
      ...
      image_visualization: {
        band_vis: {
          ...
          max: [230],
          palette: [
            '000000', '3333ff', '996666', 'cc6699', 'e1e1e1', 'ffff00', '666666',
            '993399', '501b50', 'cccc00', 'cc6600', 'ff9933', 'ffcc33', '7899f6',
            'ff9900', '660000', 'dae31d', '99cc00', 'd2db25', 'd1d52b', 'cacd32',
            'c3c63a', 'b9bc44', 'a7b34d', 'b9c64e', '999900', 'e9e2b1', '809769',
            '92a55b', 'ffff99', '98887c', '799b93', '5ea263', '52ae77', '41bf7a',
            'd6ff70', '8c8cff', 'd6cc00', 'ff7f00', '315491', 'cc9933', '5ea296',
            '896e43', '996633', '8f6c3d', 'b6a472', '82654a', 'a39069', 'b85900',
            'b74b15', 'ff8a8a', 'ffcccc', '6f55ca', 'ffccff', 'dc5424', 'd05a30',
            'd20000', 'cc0000', 'dc3200', 'ff6666', 'c5453b', '7442bd', 'ffcc99',
            'b5fb05', 'ccff05', '07f98c', '00ffcc', 'cc33cc', '8e7672', 'b1954f',
            '749a66', '009900', '006600', '00cc00', 'cc9900',
          ],
          bands: ['landcover'],
        },
      },
    }],
    landcover: {minimum: 10, maximum: 230, 'gee:estimated_range': false},
  },
