...

{
  ...
  summaries: {
    'gee:schema': [
      {
        name: 'study_area',
        description: |||
          LCMS currently covers CONUS and Southeastern Alaska. It will expand to include all US states
    ...
    'eo:bands': [
      ...
      },
      {
        ...
        description: 'Raw LCMS modeled probability of Shrubs. Defined as: The majority of the pixel is comprised\nof shrubs.',
      },
      {
      ...
      },
      {
        ...
        description: 'Raw LCMS modeled probability of Water. Defined as: The majority of the pixel is comprised of\nwater.',
      },
      {
  ...
  'sci:citation': |||
    USDA Forest Service. 2021. USFS Landscape Change Monitoring System
