...

{
  ...
  description: |||
    ...
    * The CONUS land use product was updated July 1st 2024, to correct an issue with the developed class.
    ...
    'eo:bands': [
      ...
      },
      {
        ...
        description: |||
          ...
          product was updated July 1st 2024, to correct an issue with the developed class.  
        |||,
        'gee:classes': [
          {
            value: 1,
