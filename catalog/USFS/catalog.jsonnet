...

{
  ...
  links: [
    ...
    ee.link.child_collection('USFS_GTAC_LCMS_v2024-10', base_url),
    ...
    ee.link.child_collection('USFS_GTAC_TreeMap_v2020', base_url),
    ee.link.child_collection('USFS_GTAC_TreeMap_v2022', base_url),
  ],
}
