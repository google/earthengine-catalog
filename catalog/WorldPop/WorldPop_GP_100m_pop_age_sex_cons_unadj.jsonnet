local id = 'WorldPop/GP/100m/pop_age_sex_cons_unadj';
...

{
  ...
  id: id,
  title:
    'WorldPop Global Project Population Data: Constrained Estimated Age and ' +
    'Sex Structures of Residential Population per 100x100m Grid Square',
