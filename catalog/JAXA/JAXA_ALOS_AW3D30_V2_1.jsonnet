local id = 'JAXA/ALOS/AW3D30/V2_1';
local latest_id = 'JAXA/ALOS/AW3D30/V3_2';
local predecessor_id = 'JAXA/ALOS/AW3D30/V1_1';
...

{
  ...
  description: |||
    ...
    In the version 2.1, released in April 2018, the source AW3D DSM has been upgraded
    to version 2. Masks of the land water and low correlation pixels were also filled
    with existing DEMs in addition to the cloud and snow pixels between 60 degrees
    North and 60 degrees South. In Japan area, filling was carried out after updating
  ...
  providers: [
    ee.producer_provider('JAXA Earth Observation Research Center', 'https://www.eorc.jaxa.jp/ALOS/en/aw3d30/'),
  ...
  summaries: {
    ...
    'eo:bands': [
      ...
      {
        name: 'AVE_MSK',
        description: '8-bit mask for the ave band.',
        'gee:bitmask': {
          bitmask_parts: [
            {
              ...
              values: [
                ...
                },
                {
                  value: 4,
                  description: |||
                    Void filled with National Land Numerical Information
                    10m DEM by Geographical Survey Institute of Japan (valid).
                  |||,
                },
                {
                  value: 8,
  ...
  'gee:terms_of_use': |||
    ...
    Surface Model](https://www.eorc.jaxa.jp/ALOS/en/aw3d30/).
  |||,
}
