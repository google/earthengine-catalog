...

{
  ...
  summaries: {
    ...
    label: {minimum: 10, maximum: 30, 'gee:estimated_range': false},
    residential: {minimum: 0, maximum: 1, 'gee:estimated_range': false},
    non_residential: {minimum: 0, maximum: 1, 'gee:estimated_range': false},
    open_space: {minimum: 0, maximum: 1, 'gee:estimated_range': false},
    'gee:visualizations': [{
