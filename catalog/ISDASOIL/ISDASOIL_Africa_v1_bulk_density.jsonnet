local id = 'ISDASOIL/Africa/v1/bulk_density';
...

{
  ...
  id: id,
  title: 'iSDAsoil Bulk Density, <2mm Fraction',
  version: 'v1',
  ...
  summaries: {
    ...
    'gee:visualizations': [
      {
        display_name: 'Bulk density, <2mm fraction, predicted mean at 0-20 cm depth',
        lookat: {
          lat: 25.0,
          lon: -3.0,
          zoom: 2,
