...

{
  ...
  description: |||
    ...
    **Accessing Raw Data (.zarr)**
    ...
    The 2019 forecast dataset is an additional year of forecast data, complimenting the 2020-2024 data available through this dataset listing. The 2019 forecasts are, as in the paper, ERA5 initialized forecasts for a model trained on ERA5.
