...

{
  ...
  description: |||
    WeatherNext 2 Mean is the mean of 64 ensembles of an experimental dataset of
    global medium-range ensemble weather forecasts produced by an operational
    version of Google DeepMind's [Functional Network Generative weather model](https://arxiv.org/abs/2506.10772).
