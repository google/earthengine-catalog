local id = 'projects/gcp-public-data-weathernext/assets/weathernext_2_0_0_mean';
...

{
  ...
  id: id,
  title: 'WeatherNext 2 Mean',
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    WeatherNext 2 Mean is the **mean of 64 ensembles** of an experimental
    dataset of global medium-range ensemble weather forecasts produced by an
    operational version of Google DeepMind's [Functional Network Generative weather model](https://arxiv.org/abs/2506.10772).
    For a dataset containing all ensemble members, please see the (non-mean)
    [WeatherNext 2 dataset](projects_gcp-public-data-weathernext_assets_weathernext_2_0_0).
    ...
    **Dissemination Schedule**
    ...
    Ensemble mean of all steps are released at once. All times are in the UTC
    ...
    **Accessing Raw Data (.zarr)**
    ...
    ("Historic Experimental Data") is available at `gs://weathernext/weathernext_2_0_0_mean/zarr`.
  ...
  'sci:citation': |||
    ...
    "© 2026 DeepMind Technologies Limited's machine learning models used to
    create the experimental data made available at
    [https://developers.google.com/earth-engine/datasets/catalog/projects_gcp-public-data-weathernext_assets_weathernext_2_0_0_mean](https://developers.google.com/earth-engine/datasets/catalog/projects_gcp-public-data-weathernext_assets_weathernext_2_0_0_mean)
