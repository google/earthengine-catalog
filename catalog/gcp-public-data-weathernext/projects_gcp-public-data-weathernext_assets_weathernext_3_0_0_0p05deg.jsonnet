...

{
  ...
  description: |||
    ...
    models with raw observations](TODO(mahrsee): Add link).
    ...
    *   **Research paper**: More information on the underlying research model is
        described in [INSERT PAPER](TODO(mahrsee): Add link). Please note that
    ...
    **Acknowledgements**
    ...
    please see our [acknowledgements page](TODO(mahrsee): Add link).
  |||,
  license: license.id,
