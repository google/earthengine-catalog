local id = 'CSP/ERGo/1_0/US/CHILI';
local subdir = 'CSP';
...

{
  ...
  id: id,
  title: 'US NED CHILI (Continuous Heat-Insolation Load Index)',
  version: '1.0',
    ...
    'eo:bands': [
      {
        name: 'constant',
        description: |||
          NED-derived CHILI index ranging from 0 (very cool) to 255
