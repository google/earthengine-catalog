local id = 'CSP/ERGo/1_0/Global/SRTM_landforms';
local subdir = 'CSP';
...

{
  ...
  description: |||
    ...
    based on the 30m SRTM DEM (available in EE as USGS/SRTMGL1_003).
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        name: 'constant',
        description: 'SRTM-derived landform classes',
        'gee:classes': [
          {
            value: 11,
            color: '141414',
