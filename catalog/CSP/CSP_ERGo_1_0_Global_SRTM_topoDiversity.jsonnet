local id = 'CSP/ERGo/1_0/Global/SRTM_topoDiversity';
local subdir = 'CSP';
...

{
  ...
  id: id,
  title: 'Global SRTM Topographic Diversity',
  version: '1.0',
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        name: 'constant',
        description: 'SRTM-derived topographic diversity',
      },
    ],
    'gee:visualizations': [
      {
        display_name: 'SRTM Topographic Diversity',
        lookat: {
          lat: 39.724,
          lon: -111.313,
          zoom: 6,
