local id = 'CSP/ERGo/1_0/Global/ALOS_topoDiversity';
local subdir = 'CSP';
...

{
  ...
  id: id,
  title: 'Global ALOS Topographic Diversity',
  version: '1.0',
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        name: 'constant',
        description: 'ALOS-derived topographic diversity',
      },
    ],
    'gee:visualizations': [
      {
        display_name: 'ALOS Topographic Diversity',
        lookat: {
          lat: 39.724,
          lon: -111.313,
          zoom: 6,
