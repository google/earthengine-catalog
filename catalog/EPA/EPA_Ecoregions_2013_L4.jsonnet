local id = 'EPA/Ecoregions/2013/L4';
local subdir = 'EPA';
...

{
  ...
  id: id,
  title: 'US EPA Ecoregions (Level IV)',
  version: '2013',
  ...
  summaries: {
    'gee:schema': [
      ...
      {
        name: 'l4_key',
        description: 'US Level IV Code and Name',
        type: ee_const.var_type.string,
      },
      {
        name: 'us_l4code',
        description: 'Code for Level IV Ecoregion (US/USEPA)',
        type: ee_const.var_type.string,
      },
      {
        name: 'us_l4name',
        description: 'Name for Level IV Ecoregion (US/USEPA)',
        type: ee_const.var_type.string,
      },
    ],
    'gee:visualizations': [
