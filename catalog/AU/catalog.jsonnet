...

{
  ...
  links: [
    ...
    ee.link.child_collection('AU_ELVIS_ELVIS_50cm', base_url),
    ee.link.child_collection('AU_ELVIS_ELVIS_1m', base_url),
    ee.link.child_collection('AU_ELVIS_ELVIS_2m', base_url),
    ee.link.child_collection('AU_ELVIS_ELVIS_5m', base_url),
