...

{
  ...
  title: 'Oxford MAP LST: Malaria Atlas Project Gap-Filled Nighttime Land Surface Temperature [deprecated]',
  ...
  description: |||
    ...
    to produce the monthly &asymp;5km product.
  ...
  ee.link.successor(
        'projects/malariaatlasproject/assets/LST_Night_v061/1km/Monthly',
        ee_const.catalog_base + 'malariaatlasproject/projects_malariaatlasproject_assets_LST_Night_v061_1km_Monthly.json'),
  ],
