...
local description = importstr 'AIRBUS_SPOT_2_4_5_BRAZIL_2007_2009_PMS_NC_V1_description.md';
...

{
  ...
  id: id,
  title: 'Airbus SPOT Pansharpened Pseudo Natural Color (PMS_NC) Imagery 5-10m, Brazil',
  version: version,
  ...
  summaries: {
    ...
    'eo:bands': [
      ...
      {
        name: 'B',
        description: 'Pansharpened blue reflectance, representing the synthetic blue channel of the pseudo-natural color product for SPOT 2, 4, and 5',
        'gee:units': units.dn,
      },
      {
        name: 'cloud_mask',
