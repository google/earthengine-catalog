...

{
  ...
  id: id,
  title: 'SPOT 2, 4, 5 Brazil Pseudo Natural Color (MS_NC) V1',
  version: version,
  'gee:type': ee_const.gee_type.image_collection,
  'gee:status': 'beta',
  description: importstr 'AIRBUS_SPOT_2_4_5_BRAZIL_2007_2009_MS_NC_V1_description.md',
  license: license.id,
  ...
  summaries: {
    ...
    'eo:bands': [
      ...
      {
        name: 'B',
        description: 'Blue reflectance, representing the synthetic blue channel of the pseudo-natural color product for SPOT 5, 4, and 2',
      },
      {
        name: 'cloud_mask',
