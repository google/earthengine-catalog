    ...
    'eo:bands': [
      {
        name: 'nidem',
        description: |||
          Primary product: elevation in meter units relative to modelled Mean Sea Level. [Band details] (https://cmi.ga.gov.au/data-products/dea/325/dea-intertidal-elevation-landsat#details)
        |||,
      ...
      },
      {
        name: 'nidem_mask',
        description: |||
          Mask - 25 m to 25 m relative to Mean Sea Level. [Band details] (https://cmi.ga.gov.au/data-products/dea/325/dea-intertidal-elevation-landsat#details)
        |||,
        'gee:units': units.meters,
      },
      {
        ...
        description: |||
          Uncertainty meters. [Band details] (https://cmi.ga.gov.au/data-products/dea/325/dea-intertidal-elevation-landsat#details)
        |||,
        'gee:units': units.meters,
      },
      {
        ...
        description: |||
          Un-cleaned elevation in meters.  [Band details] (https://cmi.ga.gov.au/data-products/dea/325/dea-intertidal-elevation-landsat#details)
        |||,
        'gee:units': units.meters,
      },
    ],
