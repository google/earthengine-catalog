...

{
  ...
  description: |||
    ...
    The definition of the four bands, including NIDEM, NIDEM_mask, NIDEM_uncertainty, and NIDEM_unfiltered please see the [Band definition]
    (https://cmi.ga.gov.au/data-products/dea/325/dea-intertidal-elevation-landsat#details)
  |||,
  license: license.id,
  ...
  summaries: {
    // TODO - Delete the whole section? Need to confirm with Damien and Kurt
    // 'gee:schema': [
    //   {
    ...
    'eo:bands': [
      {
        name: 'nidem',
        description: |||
          Primary product: elevation in meter units relative to modelled Mean Sea Level for each pixel of intertidal terrain across the Australian coastline. [Band details] (https://cmi.ga.gov.au/data-products/dea/325/dea-intertidal-elevation-landsat#details)
        |||,
      ...
      },
      {
        name: 'nidem_mask',
        description: |||
          Flags non-intertidal terrestrial pixels with elevations greater than 25 m, and sub-tidal pixels with depths greater than -25 m relative to Mean Sea Level. [Band details] (https://cmi.ga.gov.au/data-products/dea/325/dea-intertidal-elevation-landsat#details)
        |||,
        'gee:units': units.meters,
      },
      {
        ...
        description: |||
          A measure of the uncertainty of NIDEM elevations in meter units for each pixel. [Band details] (https://cmi.ga.gov.au/data-products/dea/325/dea-intertidal-elevation-landsat#details)
        |||,
        'gee:units': units.meters,
      },
      {
        ...
        description: |||
          Un-cleaned elevation in meter units relative to modelled Mean Sea Level for each pixel of intertidal terrain across the Australian coastline.  [Band details] (https://cmi.ga.gov.au/data-products/dea/325/dea-intertidal-elevation-landsat#details)
        |||,
        'gee:units': units.meters,
      },
    ],
  ...
  'sci:citation': |||
    ...
    Estuarine, Coastal and Shelf Science, 223, 115 128. [doi:10.1016/j.ecss.2019.03.006](https://doi.org/10.1016/j.ecss.2019.03.006)
  |||,
