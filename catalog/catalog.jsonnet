...

{
  ...
  links: [
    ...
    ee.link.child_catalog('IBGE', base_url),
    ...
    ee.link.child_catalog('mangrovedatahub2', base_url),
    ...
    ee.link.child_catalog('gtac-data-publish', base_url),
    ...
    ee.link.child_catalog('climate-and-sustainability', base_url),
  ],
}
