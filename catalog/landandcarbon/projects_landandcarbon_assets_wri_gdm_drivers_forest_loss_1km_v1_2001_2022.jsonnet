...
local id = 'projects/landandcarbon/assets/wri_gdm_drivers_forest_loss_1km/v1_2001_2022';
...
{
  id: id,
  title: 'WRI/Google DeepMind Global Drivers of Forest Loss 2001-2022 v1.0',
  version: version,
  ...
  providers: [
    ee.producer_provider('World Resources Institute', 'https://zenodo.org/records/15224684'),
    ee.producer_provider('Google DeepMind', 'https://deepmind.google/'),
    ee.host_provider(self_ee_catalog_url),
  ],

  extent: ee.extent_global('2001-01-01T00:00:00Z', '2023-01-01T00:00:00Z'),
