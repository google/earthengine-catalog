...
{
  TOMS_MERGED(id, version_config, title_suffix='', extra_description='', status=null)::
    local subdir = 'TOMS';

    {
      ...
      id: id,
      title: 'TOMS and OMI Merged Ozone Data v' + version_config.version + title_suffix,
      ...
      summaries: {
        gsd: [111000],
        platform: ['Aura', 'EarthProbe', 'Meteor-3', 'Nimbus-7'],
        instruments: ['OMI', 'TOMS'],
        'eo:bands': [
          {
            name: 'ozone',
