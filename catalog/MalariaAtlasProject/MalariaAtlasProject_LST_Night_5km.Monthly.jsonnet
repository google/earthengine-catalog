local id = 'MalariaAtlasProject/LST_Night_5km_Monthly';
...

{
  ...
  id: id,
  title: 'Monthly Gapfilled Nighttime Land Surface Temperature 5km from MODIS MOD11A2 v6.1 products',
  ...
  description: |||
    ...
    Monthly nighttime filenames are formatted as follows:  `LST_Night_v061.{Year}.{Month}.mean.5km.mean.tif`  
  |||,
  license: license.id,
