local id = 'LANDSAT/LC8_L1T_32DAY_TOA';
local successor_id = 'LANDSAT/LC08/C01/T1_32DAY_TOA';
...

{
  ...
  id: id,
  title: 'Landsat 8 32-Day TOA Reflectance Composite [deprecated]',
  deprecated: true,
  ...
  extent: ee.extent_global('2013-04-07T00:00:00Z', '2017-04-07T00:00:00Z'),
  summaries: {
    'eo:bands': [
      {
        name: 'B1',
