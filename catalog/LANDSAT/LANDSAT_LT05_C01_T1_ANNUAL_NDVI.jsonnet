local id = 'LANDSAT/LT05/C01/T1_ANNUAL_NDVI';
local successor_id = 'LANDSAT/COMPOSITES/C02/T1_L2_ANNUAL_NDVI';
...

{
  ...
  version: version,
  deprecated: true,
  title: 'Landsat 5 TM Collection 1 Tier 1 Annual NDVI Composite [deprecated]',
