...
local latest_id = 'LANDSAT/LT04/C02/T1_TOA';
local successor_id = 'LANDSAT/LT04/C02/T1_TOA';
...

{
  ...
  id: id,
  title: 'USGS Landsat 4 TM Collection 1 Tier 1 TOA Reflectance [deprecated]',
  version: 'C1',
  deprecated: true,
