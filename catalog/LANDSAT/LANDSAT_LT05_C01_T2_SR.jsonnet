local id = 'LANDSAT/LT05/C01/T2_SR';
...
local version_table = import 'LT5_T2_L2_versions.libsonnet';
...
local version = version_config.version;
{
  ...
  id: id,
  title: 'USGS Landsat 5 Surface Reflectance Tier 2 [deprecated]',
  deprecated: true,
  ...
  extent: ee.extent_global('1984-03-16T16:22:47Z', '2011-11-16T09:57:46Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'CLOUD_COVER',
