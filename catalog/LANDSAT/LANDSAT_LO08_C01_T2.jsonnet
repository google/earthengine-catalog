local id = 'LANDSAT/LO08/C01/T2';
local latest_id = 'LANDSAT/LC08/C02/T2';
local successor_id = 'LANDSAT/LC08/C02/T2';
...

{
  ...
  id: id,
  title: 'USGS Landsat 8 Collection 1 Tier 2 OLI Raw Scenes [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 8 Collection 1 Tier 2 OLI DN values, representing scaled, calibrated at-sensor radiance.
  ||| + landsat.tier2,
  license: license.id,
  ...
  extent: ee.extent_global('2013-04-01T13:47:25Z', null),
  summaries: {
    'gee:schema': [
      {
        name: 'BPF_NAME_OLI',
