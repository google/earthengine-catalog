local id = 'LANDSAT/LT04/C01/T1_8DAY_NBRT';
local successor_id = 'LANDSAT/COMPOSITES/C02/T1_L2_8DAY_NBR';
...

{
  ...
  version: version,
  deprecated: true,
  title: 'Landsat 4 TM Collection 1 Tier 1 8-Day NBRT Composite [deprecated]',
