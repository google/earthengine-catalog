...
local version_table = import 'LT5_PRE_L1T_versions.libsonnet';
...
local version = version_config.version;
{
  ...
  id: id,
  title: 'USGS Landsat 5 TM Raw Scenes (Orthorectified) [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 5 TM DN values, representing scaled, calibrated at-sensor radiance, orthorectified scenes only.
