local id = 'LANDSAT/LT5_L1T_ANNUAL_GREENEST_TOA';
local successor_id = 'LANDSAT/LT05/C01/T1_ANNUAL_GREENEST_TOA';
...

{
  ...
  id: id,
  title: 'Landsat 5 TM Annual Greenest-Pixel TOA Reflectance Composite [deprecated]',
  deprecated: true,
