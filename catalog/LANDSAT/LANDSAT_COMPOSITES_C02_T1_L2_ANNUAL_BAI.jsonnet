local id = 'LANDSAT/COMPOSITES/C02/T1_L2_ANNUAL_BAI';
local subdir = 'LANDSAT';
local version = 'COMPOSITES/C02';
local predecessor_id = 'LANDSAT/LC08/C01/T1_ANNUAL_BAI';
local latest_id = id;
...

{
  ...
  id: id,
  version: version,
  title: 'Landsat Collection 2 Tier 1 Level 2 Annual BAI Composite',
