local id = 'LANDSAT/LE07/C01/T2_SR';
local successor_id = 'LANDSAT/LE07/C02/T1_L2';
...

{
  ...
  id: id,
  title: 'USGS Landsat 7 Surface Reflectance Tier 2 [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    This dataset is the atmospherically
    corrected surface reflectance from the Landsat 7 ETM+ sensor.
