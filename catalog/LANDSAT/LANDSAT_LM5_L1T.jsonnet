...

{
  ...
  description: |||
    Landsat 5 MSS DN values, representing scaled, calibrated at-sensor radiance, orthorectified scenes only.
  ...
  extent: ee.extent_global('1984-03-04T18:17:36Z', '2013-01-07T17:51:50Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'CLOUD_COVER',
