...
local version_table = import 'LC8_PRE_L1T_TOA_versions.libsonnet';
...

{
  ...
  id: id,
  title: 'USGS Landsat 8 TOA Reflectance (Orthorectified) [deprecated]',
  deprecated: true,
