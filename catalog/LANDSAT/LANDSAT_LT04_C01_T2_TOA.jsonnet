local id = 'LANDSAT/LT04/C01/T2_TOA';
local latest_id = 'LANDSAT/LT04/C02/T2_TOA';
local successor_id = 'LANDSAT/LT04/C02/T2_TOA';
...

{
  ...
  id: id,
  title: 'USGS Landsat 4 TM Collection 1 Tier 2 TOA Reflectance [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 4 TM Collection 1 Tier 2 calibrated top-of-atmosphere (TOA) reflectance.
  ||| + landsat.toa,
  license: license.id,
