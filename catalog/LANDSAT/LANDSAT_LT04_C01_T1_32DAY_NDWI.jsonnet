local id = 'LANDSAT/LT04/C01/T1_32DAY_NDWI';
local successor_id = 'LANDSAT/COMPOSITES/C02/T1_L2_32DAY_NDWI';
...

{
  ...
  version: version,
  deprecated: true,
  title: 'Landsat 4 TM Collection 1 Tier 1 32-Day NDWI Composite [deprecated]',
