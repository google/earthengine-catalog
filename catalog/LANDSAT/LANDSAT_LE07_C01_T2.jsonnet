local id = 'LANDSAT/LE07/C01/T2';
local latest_id = 'LANDSAT/LE07/C02/T2';
local successor_id = 'LANDSAT/LE07/C02/T2';
...

{
  ...
  id: id,
  title: 'USGS Landsat 7 Collection 1 Tier 2 Raw Scenes [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 7 Collection 1 Tier 2 DN values, representing scaled, calibrated at-sensor radiance.
