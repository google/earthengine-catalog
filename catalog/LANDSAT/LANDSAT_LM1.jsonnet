...

{
  ...
  id: id,
  title: 'USGS Landsat 1 MSS Raw Scenes [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 1 MSS DN values, representing scaled, calibrated at-sensor radiance.
  ...
  extent: ee.extent_global('1972-07-25T04:00:01Z', '1978-01-07T16:17:06Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'CLOUD_COVER',
