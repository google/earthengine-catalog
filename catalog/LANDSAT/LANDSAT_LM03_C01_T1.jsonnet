local id = 'LANDSAT/LM03/C01/T1';
local latest_id = 'LANDSAT/LM03/C02/T1';
local successor_id = 'LANDSAT/LM03/C02/T1';
...

{
  ...
  id: id,
  title: 'USGS Landsat 3 MSS Collection 1 Tier 1 Raw Scenes [deprecated]',
  version: 'C1',
  deprecated: true,
