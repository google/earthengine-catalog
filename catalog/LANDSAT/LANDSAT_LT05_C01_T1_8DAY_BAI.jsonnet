local id = 'LANDSAT/LT05/C01/T1_8DAY_BAI';
local successor_id = 'LANDSAT/COMPOSITES/C02/T1_L2_8DAY_BAI';
...

{
  ...
  version: version,
  deprecated: true,
  title: 'Landsat 5 TM Collection 1 Tier 1 8-Day BAI Composite [deprecated]',
