local id = 'LANDSAT/LM1_L1T';
local successor_id = 'LANDSAT/LM01/C01/T1';
...

{
  ...
  id: id,
  title: 'USGS Landsat 1 MSS Raw Scenes (Orthorectified) [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 1 MSS DN values, representing scaled, calibrated at-sensor radiance, orthorectified scenes only.
  ...
  extent: ee.extent_global('1972-07-25T18:12:04Z', '1978-01-07T16:15:26Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'CLOUD_COVER',
