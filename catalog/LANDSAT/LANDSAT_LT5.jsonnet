...
local version_table = import 'LT5_PRE_versions.libsonnet';
...
local version = version_config.version;
{
  ...
  id: id,
  title: 'USGS Landsat 5 TM Raw Scenes [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 5 TM DN values, representing scaled, calibrated at-sensor radiance.
  ...
  extent: ee.extent_global('1984-03-05T15:38:45Z', '2012-05-05T17:54:06Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'CLOUD_COVER',
