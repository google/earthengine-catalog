local id = 'LANDSAT/LE07/C01/T1_ANNUAL_RAW';
...

{
  ...
  description: |||
    These Landsat 7 Collection 1 Tier 1 composites are made from Tier 1 orthorectified scenes, using the DN values, representing scaled, calibrated at-sensor radiance.
