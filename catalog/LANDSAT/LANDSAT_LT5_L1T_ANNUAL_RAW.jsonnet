local id = 'LANDSAT/LT5_L1T_ANNUAL_RAW';
local successor_id = 'LANDSAT/LT05/C01/T1_ANNUAL_RAW';
...

{
  ...
  id: id,
  title: 'Landsat 5 TM Annual Raw Composite [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    These Landsat 5 TM composites are made from Level L1T orthorectified scenes, using the DN values, representing scaled, calibrated at-sensor radiance.
