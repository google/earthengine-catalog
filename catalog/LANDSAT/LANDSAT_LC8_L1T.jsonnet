...
local version_table = import 'LC8_PRE_L1T_versions.libsonnet';
...
local version = version_config.version;
{
  ...
  id: id,
  title: 'USGS Landsat 8 Raw Scenes (Orthorectified) [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 8 DN values, representing scaled, calibrated at-sensor radiance, orthorectified scenes only.
  ...
  extent: ee.extent_global('2013-04-11T00:14:45Z', '2017-05-01T08:14:12Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'BPF_NAME_OLI',
      ...
      },
      {
        name: 'BPF_NAME_TIRS',
        description: |||
          The file name for the Bias Parameter File (BPF) used to generate the product, if applicable. This only applies to products that contain TIRS bands.
        |||,
        type: ee_const.var_type.string,
      },
      {
