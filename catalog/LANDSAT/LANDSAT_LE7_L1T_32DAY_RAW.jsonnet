local id = 'LANDSAT/LE7_L1T_32DAY_RAW';
local successor_id = 'LANDSAT/LE07/C01/T1_32DAY_RAW';
...

{
  ...
  id: id,
  title: 'Landsat 7 32-Day Raw Composite [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    These Landsat 7 composites are made from Level L1T orthorectified scenes, using the DN values, representing scaled, calibrated at-sensor radiance.
  ...
  extent: ee.extent_global('1999-01-01T00:00:00Z', '2017-04-07T00:00:00Z'),
  summaries: {
    'eo:bands': [
      {
        name: 'B1',
