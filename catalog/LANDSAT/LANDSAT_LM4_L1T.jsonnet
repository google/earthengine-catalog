local id = 'LANDSAT/LM4_L1T';
local successor_id = 'LANDSAT/LM04/C01/T1';
...

{
  ...
  id: id,
  title: 'USGS Landsat 4 MSS Raw Scenes (Orthorectified) [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 4 MSS DN values, representing scaled, calibrated at-sensor radiance, orthorectified scenes only.
  ...
  extent: ee.extent_global('1982-08-06T20:50:59Z', '1992-10-14T19:35:17Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'CLOUD_COVER',
