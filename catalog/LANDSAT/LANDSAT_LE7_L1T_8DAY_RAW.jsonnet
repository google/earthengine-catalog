local id = 'LANDSAT/LE7_L1T_8DAY_RAW';
local successor_id = 'LANDSAT/LE07/C01/T1_8DAY_RAW';
...

{
  ...
  id: id,
  title: 'Landsat 7 8-Day Raw Composite [deprecated]',
  deprecated: true,
  ...
  extent: ee.extent_global('1999-01-01T00:00:00Z', '2017-04-23T00:00:00Z'),
  summaries: {
    'eo:bands': [
      {
        name: 'B1',
