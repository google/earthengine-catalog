local id = 'LANDSAT/LM2_L1T';
local successor_id = 'LANDSAT/LM02/C01/T1';
...

{
  ...
  id: id,
  title: 'USGS Landsat 2 MSS Raw Scenes (Orthorectified) [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 2 MSS DN values, representing scaled, calibrated at-sensor radiance, orthorectified scenes only.
  ...
  extent: ee.extent_global('1975-01-24T14:44:13Z', '1982-02-08T01:17:27Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'CLOUD_COVER',
