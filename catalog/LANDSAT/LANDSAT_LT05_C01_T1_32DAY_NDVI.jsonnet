local id = 'LANDSAT/LT05/C01/T1_32DAY_NDVI';
local successor_id = 'LANDSAT/COMPOSITES/C02/T1_L2_32DAY_NDVI';
...

{
  ...
  version: version,
  deprecated: true,
  title: 'Landsat 5 TM Collection 1 Tier 1 32-Day NDVI Composite [deprecated]',
