local id = 'LANDSAT/LC08/C01/T1_TOA';
...
local version_table = import 'LC8_T1_TOA_versions.libsonnet';
...
local version = version_config.version;
{
  ...
  id: id,
  title: 'USGS Landsat 8 Collection 1 Tier 1 TOA Reflectance [deprecated]',
  version: version,
  deprecated: true,
