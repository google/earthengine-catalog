local id = 'LANDSAT/LC08/C01/T1';
local latest_id = 'LANDSAT/LC08/C02/T1';
local successor_id = 'LANDSAT/LC08/C02/T1';
...

{
  ...
  id: id,
  title: 'USGS Landsat 8 Collection 1 Tier 1 Raw Scenes [deprecated]',
  deprecated: true,
