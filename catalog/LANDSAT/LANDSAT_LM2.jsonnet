...

{
  ...
  id: id,
  title: 'USGS Landsat 2 MSS Raw Scenes [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 2 MSS DN values, representing scaled, calibrated at-sensor radiance.
  ...
  extent: ee.extent_global('1975-01-24T02:12:31Z', '1982-02-18T17:26:38Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'CLOUD_COVER',
