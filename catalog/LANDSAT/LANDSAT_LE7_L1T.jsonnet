...
local version_table = import 'LE7_PRE_L1T_versions.libsonnet';
...

{
  ...
  id: id,
  title: 'USGS Landsat 7 Raw Scenes (Orthorectified) [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 7 DN values, representing scaled, calibrated at-sensor radiance, orthorectified scenes only.
