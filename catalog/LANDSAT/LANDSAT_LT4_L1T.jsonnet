...
local version_table = import 'LT4_PRE_L1T_versions.libsonnet';
...
local version = version_config.version;
{
  ...
  id: id,
  title: 'USGS Landsat 4 TM Raw Scenes (Orthorectified) [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 4 TM DN values, representing scaled, calibrated at-sensor radiance, orthorectified scenes only.
