...

{
  ...
  id: id,
  title: 'USGS Landsat 3 MSS Raw Scenes (Orthorectified) [deprecated]',
  deprecated: true,
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    Landsat 3 MSS DN values, representing scaled, calibrated at-sensor radiance, orthorectified scenes only.
  ...
  extent: ee.extent_global('1978-03-07T16:22:02Z', '1983-03-31T20:55:16Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'CLOUD_COVER',
