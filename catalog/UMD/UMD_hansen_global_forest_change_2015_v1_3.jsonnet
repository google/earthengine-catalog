...
local subdir = 'UMD';
local id = 'UMD/hansen/global_forest_change_2015_v1_3';
...

{
  ...
  id: id,
  title: 'Hansen Global Forest Change v1.3 (2000-2015) [deprecated]',
  version: version,
  ...
  description: |||
    ...
    Please see the [User Notes](https://earthenginepartners.appspot.com/science-2013-global-forest/download_v1.3.html)
    for this Version 1.3 update, as well as the associated journal article:
  ...
  extent: ee.extent_global('2000-01-01T00:00:00Z', '2016-01-01T00:00:00Z'),
  summaries: {
    gsd: [
      30.92,
    ],
    'eo:bands': [
      ...
      },
      {
        name: 'lossyear',
        description: |||
          Year of gross forest cover loss event. A disaggregation of total forest
          loss to annual time scales. Encoded as either 0 (no loss) or else a value
          in the range 1-15, representing loss detected primarily in the year
          2001-2015, respectively.
        |||,
      },
    ],
    'gee:visualizations': [
