...
local subdir = 'UMD';
local id = 'UMD/hansen/global_forest_change_2016_v1_4';
...

{
  ...
  description: |||
    ...
    Please see the [User Notes](https://earthenginepartners.appspot.com/science-2013-global-forest/download_v1.4.html)
    for this Version 1.4 update, as well as the associated journal article:
    ...
    'eo:bands': [
      ...
      },
      {
        ...
        description: |||
          ...
          in the range 1-16, representing loss detected primarily in the year
          2001-2016, respectively.
        |||,
      },
    ],
    'gee:visualizations': [
