...
local subdir = 'UMD';
local id = 'UMD/hansen/global_forest_change_2013';
...
local license = spdx.cc_by_4_0;
{
  ...
  id: id,
  title: 'Hansen Global Forest Change v1.0 (2000-2012) [deprecated]',
  version: version,
  ...
  description: |||
    ...
    Please see the [User Notes](https://earthenginepartners.appspot.com/science-2013-global-forest/download_v1.0.html)
  ...
  extent: ee.extent_global('2000-01-01T00:00:00Z', '2013-01-01T00:00:00Z'),
  summaries: {
    gsd: [
      30.92,
    ],
