...

{
  ...
  links: [
    ...
    ee.link.child_collection('LARSE_GEDI_GEDI04_D_002', base_url),
    ee.link.child_collection('LARSE_GEDI_GRIDDEDVEG_002_COUNTS_V1_12KM', base_url),
    ee.link.child_collection('LARSE_GEDI_GRIDDEDVEG_002_COUNTS_V1_1KM', base_url),
    ee.link.child_collection('LARSE_GEDI_GRIDDEDVEG_002_COUNTS_V1_6KM', base_url),
