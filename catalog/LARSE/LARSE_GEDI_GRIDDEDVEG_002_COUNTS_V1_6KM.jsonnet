local id = 'LARSE/GEDI/GRIDDEDVEG_002/COUNTS/V1/6KM';
local subdir = 'LARSE';
...

{
  ...
  id: id,
  title: 'Gridded GEDI Vegetation Structure Metrics and Biomass Density with COUNTS metrics, 6KM pixel size',
  version: '1',
  'gee:type': ee_const.gee_type.image_collection,
  // TODO(simonf): figure out why require() in example scripts doesn't work
  // in tests
  'gee:user_uploaded': true,
  description: gedi_vegetation.description + 'This dataset uses the pixel size of 6KM with counts metrics.',
