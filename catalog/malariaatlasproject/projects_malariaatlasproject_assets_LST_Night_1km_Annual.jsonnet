local id = 'projects/malariaatlasproject/assets/LST_Night_v061/1km/Annual';
...

{
  ...
  id: id,
  title: 'Annual LST Night: Malaria Atlas Project Gap-Filled Nighttime Land Surface Temperature',
  'gee:status': 'beta',
