local id = 'projects/malariaatlasproject/assets/accessibility/accessibility_to_healthcare/2019_walking_only';
...

{
  ...
  id: id,
  title: 'Malaria Atlas Project Accessibility to Healthcare 2019 (Walking Only)',
  ...
  description: |||
    ...
    degrees north and 60 degrees south for a nominal year 2019. This surface
    is based on "walking-only" travel time, using non-motorized means of
    transportation only.
