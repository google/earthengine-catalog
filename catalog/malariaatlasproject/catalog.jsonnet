...

{
  ...
  links: [
    ...
    ee.link.child_collection('projects_malariaatlasproject_assets_LST_Day_v061_5km_8-Daily', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_LST_Day_v061_5km_Annual', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_LST_Day_v061_5km_Monthly', base_url),
    ...
    ee.link.child_collection('projects_malariaatlasproject_assets_LST_Night_v061_5km_8-Daily', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_LST_Night_v061_5km_Annual', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_LST_Night_v061_5km_Monthly', base_url),
    ...
    ee.link.child_collection('projects_malariaatlasproject_assets_EVI_v061_5km_8-Daily', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_EVI_v061_5km_Annual', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_EVI_v061_5km_Monthly', base_url),
    ...
    ee.link.child_collection('projects_malariaatlasproject_assets_TCB_v061_5km_8-Daily', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_TCB_v061_5km_Annual', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_TCB_v061_5km_Monthly', base_url),
    ...
    ee.link.child_collection('projects_malariaatlasproject_assets_TCW_v061_5km_8-Daily', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_TCW_v061_5km_Annual', base_url),
    ee.link.child_collection('projects_malariaatlasproject_assets_TCW_v061_5km_Monthly', base_url),
  ],
}