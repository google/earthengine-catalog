...
local version_table = import 'templates/LST_Day_monthly_versions.libsonnet';
...

{
  ...
  id: id,
  title: 'LST Day: Malaria Atlas Project Gap-Filled Daytime Land Surface Temperature (Monthly 1km)',
  version: version,
