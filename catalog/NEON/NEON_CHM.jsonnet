...

{
  ...
  description: |||
    ...
    Documentation: [NEON DP3.30015.001 Quick Start
    Guide](https://data.neonscience.org/api/v0/documents/quick-start-guides/NEON.QSG.DP3.30015.001v1?inline=true&fallback=html)
  |||,
  license: license.id,
