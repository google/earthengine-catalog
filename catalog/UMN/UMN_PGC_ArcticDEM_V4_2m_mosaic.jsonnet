...

{
  ...
  description: |||
    ...
    This version (V4.1) These mosaics include additional raster bands:
  ...
  summaries: {
    ...
    'eo:bands': [
      ...
      {
        name: 'mindate',
        description: 'Earliest date of the source DEMs used to build the mosaic (YYYYMMDD).',
      },
      {
        name: 'maxdate',
        description: 'Latest date of the source DEMs used to build the mosaic (YYYYMMDD).',
      },
       {
        name: 'datamask',
        description: 'Data mask indicating valid data pixels.',
      },
    ],
    'gee:visualizations': [
      {
