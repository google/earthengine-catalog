local id = 'CIESIN/GPWv4/unwpp-adjusted-population-density';
local successor_id = 'CIESIN/GPWv411/GPW_UNWPP-Adjusted_Population_Density';
local subdir = 'CIESIN';
...

{
  ...
  id: id,
  title: 'GPWv4: Gridded Population of the World Version 4, UN-Adjusted Population Density [deprecated]',
  version: 'v4',
  deprecated: true,
  ...
  'sci:doi': '10.7927/H4HX19NJ',
  'sci:citation': |||
    Center for International Earth Science Information Network - CIESIN -
    Columbia University. 2016. Gridded Population of the World, Version 4
    (GPWv4): Population Density Adjusted to Match 2015 Revision of UN WPP
    Country Totals. Palisades, NY: NASA Socioeconomic Data and Applications
    Center (SEDAC). [https://doi.org/10.7927/H4HX19NJ](https://doi.org/10.7927/H4HX19NJ).
