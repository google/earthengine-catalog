...

{
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        name: 'radar_signals',
        description: 'Observed radar backscatter values (dB)',
        'gee:scale': 0.01,
      }
    ],
    'gee:visualizations': [{
      display_name: 'radar_signals',
