...

{
  ...
  id: id,
  title: 'MYD21C1.061 Aqua Land Surface Temperature and 3-Band Emissivity Daily L3 Global 0.05 Deg CMG',
  version: 'V061',
  ...
  description: |||
    ...
    * [General Documentation](https://ladsweb.modaps.eosdis.nasa.gov/filespec/MODIS/6/MYD21C1)
  |||,
  license: license.id,
  links: ee.standardLinks(subdir, id) + [
    {
      rel: ee_const.rel.cite_as,
      href: 'https://doi.org/10.5067/MODIS/MYD21C1.061',
    },
  ],
  keywords: [
    'aqua',
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD21C1.061'),
    ee.host_provider(self_ee_catalog_url),
  ],
  'gee:provider_ids': [
    'C1646692274-LPDAAC_ECS',
  ],
  ...
  'sci:doi': '10.5067/MODIS/MYD21C1.061',
  'sci:citation': |||
