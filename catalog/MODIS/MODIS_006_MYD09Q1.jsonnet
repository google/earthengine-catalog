local id = 'MODIS/006/MYD09Q1';
local versions = import 'versions.libsonnet';
local version_table = import 'templates/MYD09Q1_versions.libsonnet';
...

{
  ...
  id: id,
  title: 'MYD09Q1.006 Aqua Surface Reflectance 8-Day Global 250m [deprecated]',
  ...
  description: |||
    ...
    * [General Documentation](https://ladsweb.modaps.eosdis.nasa.gov/filespec/MODIS/6/MYD09Q1)
  |||,
  license: license.id,
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD09Q1.006'),
    ee.host_provider(version_config.ee_catalog_url),
  ],
  'gee:provider_ids': [
    'C193529461-LPDAAC_ECS',
  ],
  extent: ee.extent_global('2002-07-04T00:00:00Z', '2023-02-18T00:00:00Z'),
  summaries: template.summaries {
    platform: [
      'Aqua',
    ],
  },
  'sci:doi': '10.5067/MODIS/MYD09Q1.006',
  'sci:citation': |||
