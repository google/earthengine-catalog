...

{
  ...
  id: id,
  title: 'MOD13C1.061: Terra Vegetation Indices 16-Day L3 Global 0.05 Deg Climate Modeling Grid',
  version: '6.1',
  ...
  description: |||
    ...
    for MOD13C1 bands are already applied to assets ingested into Earth
    Engine.
  |||,
  license: license.id,
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MOD13C1.061'),
  ...
  'sci:doi': '10.5067/MODIS/MOD13C1.061',
  'sci:citation': |||
