local id = 'MODIS/006/MYD11A2';
local latest_id = 'MODIS/061/MYD11A2';
local successor_id = 'MODIS/061/MYD11A2';
local subdir = 'MODIS';
...

{
  ...
  id: id,
  title: 'MYD11A2.006 Aqua Land Surface Temperature and Emissivity 8-Day Global 1km',
  version: 'V006',
  ...
  description: |||
    ...
    * [General Documentation](https://ladsweb.modaps.eosdis.nasa.gov/filespec/MODIS/6/MYD11A2)
  |||,
  license: license.id,
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD11A2.006'),
  ...
  'sci:doi': '10.5067/MODIS/MYD11A2.006',
  'sci:citation': |||
