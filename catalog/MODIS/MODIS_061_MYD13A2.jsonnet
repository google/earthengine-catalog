local id = 'MODIS/061/MYD13A2';
local predecessor_id = 'MODIS/006/MYD13A2';
local subdir = 'MODIS';
...

{
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD13A2.061'),
  ...
  'sci:doi': '10.5067/MODIS/MYD13A2.061',
  'sci:citation': |||
