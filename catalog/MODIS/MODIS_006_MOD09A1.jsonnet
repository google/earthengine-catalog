local id = 'MODIS/006/MOD09A1';
local latest_id = 'MODIS/061/MOD09A1';
local successor_id = 'MODIS/061/MOD09A1';
local subdir = 'MODIS';
...

{
  ...
  id: id,
  title: 'MOD09A1.006 Terra Surface Reflectance 8-Day Global 500m [deprecated]',
  deprecated: true,
  version: 'V006',
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    The MOD09A1 V6 product provides an estimate of the surface
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MOD09A1.006'),
    ee.host_provider(self_ee_catalog_url),
  ],
  'gee:provider_ids': [
    'C193529899-LPDAAC_ECS',
  ],
  ...
  'sci:doi': '10.5067/MODIS/MOD09A1.006',
  'sci:citation': |||
