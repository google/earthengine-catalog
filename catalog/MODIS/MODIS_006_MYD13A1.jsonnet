local id = 'MODIS/006/MYD13A1';
local latest_id = 'MODIS/061/MYD13A1';
local successor_id = 'MODIS/061/MYD13A1';
local subdir = 'MODIS';
...

{
  ...
  id: id,
  title: 'MYD13A1.006 Aqua Vegetation Indices 16-Day Global 500m',
  version: 'V006',
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    The MYD13A1 V6 product provides a Vegetation Index (VI)
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD13A1.006'),
