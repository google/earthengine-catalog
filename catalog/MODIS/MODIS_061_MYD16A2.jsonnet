...
// local version_table = import 'templates/MYD16A2_versions.libsonnet';
...
local template = import 'templates/MODIS_061_MYD16A2.libsonnet';
...

{
  ...
  description: |||
    ...
    within the 8-day composite period.
