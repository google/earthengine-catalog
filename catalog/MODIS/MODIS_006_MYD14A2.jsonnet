local id = 'MODIS/006/MYD14A2';
local latest_id = 'MODIS/061/MYD14A2';
local successor_id = 'MODIS/061/MYD14A2';
local subdir = 'MODIS';
...

{
  ...
  id: id,
  title: 'MYD14A2.006: Aqua Thermal Anomalies & Fire 8-Day Global 1km',
  version: 'V006',
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD14A2.006'),
