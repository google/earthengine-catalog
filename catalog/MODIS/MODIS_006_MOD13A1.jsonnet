local id = 'MODIS/006/MOD13A1';
local latest_id = 'MODIS/061/MOD13A1';
local successor_id = 'MODIS/061/MOD13A1';
local subdir = 'MODIS';
...

{
  ...
  id: id,
  title: 'MOD13A1.006 Terra Vegetation Indices 16-Day Global 500m',
  version: 'V006',
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    The MOD13A1 V6 product provides a Vegetation Index (VI)
    ...
    * [General Documentation](https://ladsweb.modaps.eosdis.nasa.gov/filespec/MODIS/6/MOD13A1)
  |||,
  license: license.id,
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MOD13A1.006'),
