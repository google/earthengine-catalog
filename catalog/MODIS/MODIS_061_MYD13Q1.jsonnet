local id = 'MODIS/061/MYD13Q1';
local predecessor_id = 'MODIS/006/MYD13Q1';
local subdir = 'MODIS';
...

{
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD13Q1.061'),
  ...
  'sci:doi': '10.5067/MODIS/MYD13Q1.061',
  'sci:citation': |||
