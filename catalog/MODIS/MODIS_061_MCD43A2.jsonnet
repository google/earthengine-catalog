local id = 'MODIS/061/MCD43A2';
local predecessor_id = 'MODIS/006/MCD43A2';
local subdir = 'MODIS';
...

{
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MCD43A2.061'),
