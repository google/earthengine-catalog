...

{
  ...
  id: id,
  title: 'MYD21A1D.061 Aqua Land Surface Temperature and 3-Band Emissivity Daily Global 1km',
  version: 'V061',
  ...
  description: |||
    ...
    * [General Documentation](https://ladsweb.modaps.eosdis.nasa.gov/filespec/MODIS/6/MYD21A1D)
  |||,
  license: license.id,
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD21A1D.061'),
    ee.host_provider(self_ee_catalog_url),
  ],
  'gee:provider_ids': [
    'C1621446628-LPDAAC_ECS',
  ],
  ...
  'sci:doi': '10.5067/MODIS/MYD21A1D.061',
  'sci:citation': |||
