...

{
  ...
  description: |||
    The MYD13Q1 V6 product provides a Vegetation Index (VI)
  ...
  links: ee.standardLinks(subdir, id) + [
    {
      ...
      href: 'https://doi.org/10.5067/MODIS/MYD13Q1.006',
    },
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD13Q1.006'),
    ee.host_provider(version_config.ee_catalog_url),
  ],
  'gee:provider_ids': [
    'C194001221-LPDAAC_ECS',
  ],
  extent: ee.extent_global('2002-07-04T00:00:00Z', '2023-02-10T00:00:00Z'),
  summaries: template.summaries {
    platform: [
      'Aqua',
    ],
  },
  'sci:doi': '10.5067/MODIS/MYD13Q1.006',
  'sci:citation': |||
