...

{
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYDOCGA.006'),
  ...
  'sci:doi': '10.5067/MODIS/MYDOCGA.006',
  'sci:citation': |||
