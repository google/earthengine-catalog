local id = 'MODIS/MYD09GA';
local successor_id = 'MODIS/006/MYD09GA';
local subdir = 'MODIS';
...

{
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://lpdaac.usgs.gov/dataset_discovery/modis/modis_products_table/myd09ga'),
