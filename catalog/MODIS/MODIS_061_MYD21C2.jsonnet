...

{
  ...
  id: id,
  title: 'MYD21C2.061 Aqua Land Surface Temperature and 3-Band Emissivity 8-Day L3 Global 0.05 Deg CMG',
  version: 'V061',
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD21C2.061'),
    ee.host_provider(self_ee_catalog_url),
  ],
  'gee:provider_ids': [
    'C1646692326-LPDAAC_ECS',
  ],
  ...
  'sci:doi': '10.5067/MODIS/MYD21C2.061',
  'sci:citation': |||
