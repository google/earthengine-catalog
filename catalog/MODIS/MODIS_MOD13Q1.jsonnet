local id = 'MODIS/MOD13Q1';
local successor_id = 'MODIS/006/MOD13Q1';
local subdir = 'MODIS';
...

{
  ...
  id: id,
  title: 'MOD13Q1.005 Vegetation Indices 16-Day Global 250m [deprecated]',
  deprecated: true,
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://lpdaac.usgs.gov/dataset_discovery/modis/modis_products_table/mod13q1'),
