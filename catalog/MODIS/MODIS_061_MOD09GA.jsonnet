local id = 'MODIS/061/MOD09GA';
local predecessor_id = 'MODIS/006/MOD09GA';
local subdir = 'MODIS';
...

{
  ...
  description: |||
    ...
    * [General Documentation](https://ladsweb.modaps.eosdis.nasa.gov/filespec/MODIS/6/MOD09GA)
  |||,
  license: license.id,
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MOD09GA.061'),
    ee.host_provider(self_ee_catalog_url),
  ],
  'gee:provider_ids': [
    'C1621091648-LPDAAC_ECS',
  ],
  ...
  'sci:doi': '10.5067/MODIS/MOD09GA.061',
  'sci:citation': |||
