local id = 'MODIS/006/MOD09GQ';
local latest_id = 'MODIS/061/MOD09GQ';
local successor_id = 'MODIS/061/MOD09GQ';
local subdir = 'MODIS';
...

{
  ...
  id: id,
  title: 'MOD09GQ.006 Terra Surface Reflectance Daily Global 250m',
  version: 'V006',
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MOD09GQ.006'),
