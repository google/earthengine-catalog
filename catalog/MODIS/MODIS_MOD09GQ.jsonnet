local id = 'MODIS/MOD09GQ';
local successor_id = 'MODIS/006/MOD09GQ';
local subdir = 'MODIS';
...

{
  ...
  id: id,
  title: 'MOD09GQ.005 Terra Surface Reflectance Daily L2G Global 250m [deprecated]',
  deprecated: true,
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://lpdaac.usgs.gov/dataset_discovery/modis/modis_products_table/mod09gq'),
