local id = 'MODIS/061/MYD17A3HGF';
local predecessor_id = 'MODIS/006/MYD17A3HGF';
local subdir = 'MODIS';
...

{
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MYD17A3HGF.061'),
