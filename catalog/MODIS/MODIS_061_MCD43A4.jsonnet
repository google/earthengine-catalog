local id = 'MODIS/061/MCD43A4';
local predecessor_id = 'MODIS/006/MCD43A4';
local subdir = 'MODIS';
...

{
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/MODIS/MCD43A4.061'),
  ...
  'sci:doi': '10.5067/MODIS/MCD43A4.061',
  'sci:citation': |||
