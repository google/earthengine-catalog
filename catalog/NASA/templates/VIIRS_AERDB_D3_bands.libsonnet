    ...
    'eo:bands': [
      ...
      },
      {
        ...
        'gee:classes': [
          ...
          {
            value: 2,
            description: 'High Altitude Smoke',
          },
          {
            value: 3,
            description: 'Pyrocumulonimbus Clouds',
          },
          {
            value: 4,
            description: 'Non-Smoke Fine Mode',
          },
          {
            value: 5,
            description: 'Mixed',
          ...
          {
            value: 6,
            description: 'Background / Maritime',
          },
          {
            value: 7,
            description: 'Fine Dominated',
          },
        ],
      },
      {
