...

{
  ...
  description: |||
    ...
    Distribution Function (BRDF) and Albedo Version 2 product
    ...
    ninth day, which is reflected in the file name. It calculates the integrated
    black-sky albedo (BSA) at local solar noon and the white-sky albedo (WSA) for
    the three VIIRS imagery bands (I1, I2, and I3). The VNP43 data products are
    designed to promote the continuity of NASA's Moderate Resolution Imaging
    Spectroradiometer (MODIS) BRDF/Albedo data product suite.
  ...
  summaries: {
    ...
    'eo:bands': [
    ...
    ] + [
      {
        ...
        description: 'Directional hemispherical reflectance (black-sky albedo) for band ' + band,
        'gee:scale': 0.001,
      }
      for band in quality_bands
    ] + [
      {
        ...
        description: 'Bihemispherical reflectance (white-sky albedo) for band ' + band,
        'gee:scale': 0.001,
      }
      for band in quality_bands
    ],
    'gee:visualizations': [
      {
        display_name: 'Black-Sky Albedo Band I1',
        lookat: {
          lat: 46.529,
          lon: 6.746,
          zoom: 6,
  ...
  'sci:citation': |||
    Schaaf, C., Z. Wang, A. Erb, I. Paynter. VIIRS/NPP BRDF/Albedo Daily L3 Global
    500m SIN Grid V002. 2024, distributed by NASA Land Processes Distributed
    Active Archive Center, [10.5067/VIIRS/VNP43IA3.002](https://doi.org/10.5067/VIIRS/VNP43IA3.002).
  |||,
  'gee:interval': {
    type: 'cadence',
    unit: 'day',
