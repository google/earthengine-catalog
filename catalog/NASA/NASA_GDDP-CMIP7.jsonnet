...

{
  ...
  id: id,
  title: 'NEX-GDDP-CMIP7: NASA Earth Exchange Global Daily Downscaled Climate Projections (Totally Fake!)',
  version: '1',
  'gee:type': ee_const.gee_type.image_collection,
  description: |||
    The NEX-GDDP-CMIP7 dataset is presumably going to exist someday but for
    now I'm inventing it to test the new tricorder analyzer.
  |||,
  license: license.id,
