...

{
  ...
  description: |||
    ...
    daytime ECOSTRESS overpasses. The dataset is distributed in a Cloud
    Optimized GeoTIFF (COG) format and organized into a modified Military Grid
    Reference System (MGRS) tile grid. Each tile contains four layers: NDVI,
    NDVI uncertainty, albedo, and albedo uncertainty. This product is only
    generated for corresponding ECOSTRESS Land Surface Temperature and Emissivity
    tiles.
