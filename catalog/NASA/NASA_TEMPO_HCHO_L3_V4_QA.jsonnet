...
local id = 'NASA/TEMPO/HCHO_L3_V4_QA';
local version_config = versions('NASA', version_table, id);
local qa_title = ' (QA filtered)';
local qa_description = |||

  The QA Filtered TEMPO HCHO L3 V4 dataset is a quality-controlled version of
...
local qa_or_raw_link = |||
  ...
  * A version of this dataset without QA filters applied is available as [NASA/TEMPO/HCHO_L3_V4](NASA_TEMPO_HCHO_L3_V4)
|||;
