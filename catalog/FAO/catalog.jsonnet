...

{
  ...
  links: [
    ...
    ee.link.child_collection('FAO_GAUL_2025_level1', base_url),
    ee.link.child_collection('FAO_GAUL_2025_level2', base_url),
    ...
    ee.link.child_collection('FAO_GAUL_SIMPLIFIED_500m_2025_level1', base_url),
    ee.link.child_collection('FAO_GAUL_SIMPLIFIED_500m_2025_level2', base_url),
