local id = 'FAO/WAPOR/2/L1_AETI_D';
local subdir = 'FAO';
...

{
  ...
  description: |||
    The actual evapotranspiration and interception (ETIa) (dekadal, in mm/day) is the sum of the
  ...
  providers: [
    ee.producer_provider('FAO UN', 'https://wapor.apps.fao.org/catalog/WAPOR_2/1/L1_AETI_D'),
  ...
  summaries: {
    ...
    'gee:visualizations': [
      {
        display_name: 'Actual Evapotranspiration and Interception (Dekadal) [mm]',
        lookat: {
          lat: 20.0,
          lon: 17.5,
          zoom: 3,
