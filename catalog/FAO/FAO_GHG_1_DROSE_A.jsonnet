...

{
  ...
  id: id,
  title: 'Drained Organic Soils Emissions (Annual) ' + version,
  version: version,
  ...
  providers: [
    ee.producer_provider(
      'FAO UN',
      'http://fao.org/economic/ess/environment/data/organic-soils/la/'),
    ee.host_provider(self_ee_catalog_url),
  ],
  extent: ee.extent_global('1992-01-01T00:00:00Z', '2018-01-01T00:00:00Z'),
  summaries: {
    gsd: [927.67],
    'eo:bands': [
      {
    ...
    'gee:visualizations': [
      {
        ...
        lookat: {lon: 108.0, lat: -0.4, zoom: 6},
        image_visualization: {
          band_vis: {
            min: [0],
            max: [1],
  ...
  'sci:doi': '10.5194/essd-12-3113-2020',
  'sci:citation': |||
  ...
  'sci:publications': [
    {
      citation: |||
        ...
        [doi:10.5194/essd-12-3113-2020](
          https://doi.org/10.5194/essd-12-3113-2020), 2020
      |||,
      doi: '10.5194/essd-12-3113-2020',
    },
  ],
