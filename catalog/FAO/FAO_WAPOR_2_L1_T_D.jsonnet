...

{
  ...
  id: id,
  title: 'WAPOR Dekadal Transpiration',
  version: '2.0',
  ...
  providers: [
    ee.producer_provider('FAO UN', 'https://wapor.apps.fao.org/catalog/WAPOR_2/1/L1_T_D'),
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        name: 'L1_T_D',
        description: 'Transpiration (Dekadal) [mm]',
        'gee:units': 'mm',
        'gee:scale': 0.1,
      },
    ],
    'gee:visualizations': [
      {
        display_name: 'Transpiration (Dekadal) [mm]',
        lookat: {
          lat: 20.0,
          lon: 17.5,
          zoom: 3,
