...

{
  ...
  id: id,
  title: 'WAPOR Dekadal Reference Evapotranspiration',
  version: '2.0',
  ...
  providers: [
    ee.producer_provider('FAO UN', 'https://wapor.apps.fao.org/catalog/WAPOR_2/1/L1_RET_D'),
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        name: 'L1_RET_D',
        description: 'Reference Evapotranspiration (Dekadal) [mm]',
        'gee:units': 'mm',
        'gee:scale': 0.1,
      },
    ],
    'gee:visualizations': [
      {
        display_name: 'Reference Evapotranspiration (Dekadal) [mm]',
        lookat: {
          lat: 20.0,
          lon: 17.5,
          zoom: 3,
