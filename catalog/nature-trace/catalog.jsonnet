...

{
  ...
  links: [
    ...
    ee.link.child_collection('projects_nature-trace_assets_ghg_emit_mapl_emit_plumes_v1_0', base_url),
    ee.link.child_collection('projects_nature-trace_assets_ghg_emit_mapl_emit_enhancements_v1_0', base_url),
  ],
}
