  ...
  bands: [
    {
      ...
      description: |||
        ...
        of the atmospheric conditions. This parameter has units of
        kelvin (K). Temperature measured in kelvin can be converted
        to degrees Celsius by subtracting 273.15.
      |||,
    },
    {
      name: 'temperature_2m',
      ...
      description: |||
        ...
        conditions. This parameter has units of kelvin (K).
    ...
    },
    {
      ...
      description: |||
        ...
        show stronger winds. The units of this parameter are pascals
        (Pa). Mean sea level pressure is often measured in hPa and
        sometimes is presented in the old units of millibars, mb (1
        hPa = 1 mb = 100 Pa).
      |||,
    },
    {
      ...
      description: |||
        ...
        the OSTIA dataset is used. This parameter has units of
        kelvin (K). Temperature measured in kelvin can be converted
        to degrees Celsius by subtracting 273.15.
      |||,
    },
    {
      ...
      description: |||
        ...
        This parameter has units of kelvin (K). Temperature measured
        in kelvin can be converted to degrees Celsius by
        subtracting 273.15.
      |||,
    },
    {
      ...
      description: |||
        ...
        this purpose. The units of this parameter are Pascals (Pa).
        Surface pressure is often measured in hPa and sometimes is
        presented in the old units of millibars, mb (1 hPa = 1 mb=
        100 Pa).
      |||,
    },
    {
    ...
    },
    {
      ...
      description: |||
        ...
        time. This parameter has units of kelvin (K). Temperature
        measured in kelvin can be converted to degrees Celsius
    ...
    },
    {
      ...
      description: |||
        ...
        and melting of ice on inland water bodies. This parameter
        has units of kelvin (K). Temperature measured in kelvin can
    ...
    },
    {
      ...
      description: |||
        ...
        thermocline at the lake bottom. A single ice layer is used
        to represent the formation and melting of ice on inland
        water bodies. This parameter has units of kelvin (K).
        Temperature measured in kelvin can be converted to degrees
        Celsius by subtracting 273.15.
      |||,
    },
    ...
    },
    {
      ...
      description: |||
        ...
        bottom, and the lower boundary of the thermocline at the
        lake bottom. A single ice layer is used to represent the
        formation and melting of ice on inland water bodies. This
        parameter has units of kelvin (K). Temperature measured in
        kelvin can be converted to degrees Celsius by
        subtracting 273.15.
      |||,
    },
    {
    ...
    },
    {
      ...
      description: |||
        ...
        without snow can be masked out by only considering grid
        points where the snow depth (m of water equivalent) is
        greater than 0.0. This parameter has units of kelvin (K).
        Temperature measured in kelvin can be converted to degrees
        Celsius by subtracting 273.15.
      |||,
    },
    ...
    },
    {
      ...
      description: |||
        ...
        land-sea mask has a value greater than 0.5. This parameter
        has units of kelvin (K). Temperature measured in kelvin can
        be converted to degrees Celsius by subtracting 273.15.
      |||,
    },
    ...
    },
    {
      ...
      description: |||
        ...
        atmospheric conditions. This parameter has units of kelvin
        (K). Temperature measured in kelvin can be converted to
        degrees Celsius by subtracting 273.15.
      |||,
    },
    {
    ...
    },
    {
      ...
      description: |||
        ...
        temperature is calculated by interpolating between the
        lowest model level and the Earth's surface, taking account
        of the atmospheric conditions. See further information. This
        parameter has units of kelvin (K). Temperature measured in
        kelvin can be converted to degrees Celsius by
        subtracting 273.15.
      |||,
