...

{
  ...
  summaries: {
    ...
    'eo:bands': [
      ...
      },
      {
        ...
        description: |||
          Temperature of the surface of the Earth. The skin temperature is the theoretical temperature
      ...
      },
      {
        name: 'lake_ice_depth',
        description: |||
          The thickness of ice on inland water bodies (lakes, reservoirs and rivers) and coastal waters.
      ...
      },
      {
        ...
        description: |||
          The thickness of the upper most layer of an inland water body (lake, reservoirs, and rivers) or
      ...
      },
      {
        ...
        description: |||
          The temperature of the upper most layer of inland water bodies (lakes, reservoirs and rivers)
      ...
      },
      {
        ...
        description: |||
          This parameter describes the way that temperature changes with depth in the thermocline layer
          ...
          the mixed layer above and the thermocline below where temperature changes with depth.
        |||,
      },
      {
      ...
      },
      {
        name: 'snow_albedo',
        description: |||
          It is defined as the fraction of solar (shortwave) radiation reflected by the snow, across the
      ...
      },
      {
        ...
        |||,
        'gee:units': 'm of water equivalent',
      },
      {
        name: 'snowfall',
        description: |||
      ...
      },
      {
        name: 'snowmelt',
        description: |||
          Melting of snow averaged over the grid box (to find melt over snow, divide by snow fraction).
      ...
      },
      {
        ...
        description: |||
          Amount of water in the vegetation canopy and/or in a thin layer on the soil. It represents the
      ...
      },
      {
        ...
        description: |||
          Volume of water in soil layer 1 (0 - 7 cm) of the ECMWF Integrated Forecasting System. The
      ...
      },
      {
        ...
        description: |||
          Is a measure of the reflectivity of the Earth's surface. It is the fraction of solar
      ...
      },
      {
        ...
        description: |||
          Exchange of latent heat with the surface through turbulent diffusion. This variables is
      ...
      },
      {
        ...
        description: |||
          Transfer of heat between the Earth's surface and the atmosphere through the effects of
      ...
      },
      {
        ...
        description: |||
          Amount of thermal (also known as longwave or terrestrial) radiation emitted by the atmosphere
      ...
      },
      {
        ...
        description: |||
          The amount of evaporation from bare soil at the top of the land surface. This variable is
      ...
      },
      {
        ...
        description: |||
          Amount of evaporation from surface water storage like lakes and inundated areas but excluding
      ...
      },
      {
        ...
        description: |||
          The amount of evaporation from the canopy interception reservoir at the top of the canopy.
          This variable is accumulated from the beginning of the forecast time to the end of the forecast
          step.
        |||,
        'gee:units': 'm of water equivalent',
      },
      {
        ...
        description: |||
          Amount of evaporation from vegetation transpiration. This has the same meaning as root
      ...
      },
      {
        ...
        description: |||
          Potential evaporation (pev) in the current ECMWF model is computed, by making a second call to
      ...
      },
      {
        name: 'runoff',
        description: |||
          Some water from rainfall, melting snow, or deep in the soil, stays stored in the soil.
      ...
      },
      {
        ...
        description: |||
          Evaporation from snow averaged over the grid box (to find flux over snow, divide by snow
      ...
      },
      {
        ...
        description: |||
          ...
          simplified representation of transpiration (from vegetation), into vapor in the air above.
      ...
      },
      {
        ...
        description: |||
          Pressure (force per unit area) of the atmosphere on the surface of land, sea and in-land
      ...
      },
      {
        ...
        description: "Same as 'snowfall' except not accumulated and only for the given forecast step.",
        'gee:units': 'm of water equivalent',
      },
      {
        name: 'snowmelt_hourly',
        description: "Same as 'snowmelt' except not accumulated and only for the given forecast step.",
        'gee:units': 'm of water equivalent',
      },
      {
      ...
      },
      {
        ...
        description: "Same as 'evaporation_from_bare_soil' except not accumulated and\nonly for the given forecast step.",
        'gee:units': 'm of water equivalent',
      },
      {
        name: 'evaporation_from_open_water_surfaces_excluding_oceans_hourly',
        description: |||
          Same as 'evaporation_from_open_water_surfaces_excluding_oceans' except not accumulated and
          only for the given forecast step.
        |||,
        'gee:units': 'm of water equivalent',
      },
      {
        name: 'evaporation_from_the_top_of_canopy_hourly',
        description: |||
          Same as 'evaporation_from_the_top_of_canopy' except not accumulated and
          only for the given forecast step.
        |||,
        'gee:units': 'm of water equivalent',
      },
      {
        name: 'evaporation_from_vegetation_transpiration_hourly',
        description: |||
          Same as 'evaporation_from_vegetation_transpiration' except not accumulated and
          only for the given forecast step.
        |||,
        'gee:units': 'm of water equivalent',
      },
      ...
      },
      {
        ...
        description: "Same as 'snow_evaporation' except not accumulated and only for the given forecast step.",
        'gee:units': 'm of water equivalent',
      },
      {
      ...
      },
      {
        ...
        description: "Same as 'total_evaporation' except not accumulated and only for the given forecast step.",
        'gee:units': 'm of water equivalent',
      },
      {
  ...
  'sci:citation': |||
    Mu&ntilde;oz Sabater, J., (2019): ERA5-Land hourly data from 1981 to present. Copernicus Climate
