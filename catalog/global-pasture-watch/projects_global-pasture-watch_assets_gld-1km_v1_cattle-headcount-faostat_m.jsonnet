...
{
  id: id,
  title: 'GPW Cattle Headcount FAOSTAT-adjusted v' + version,
  version: version,

  description: |||
    This dataset provides annual FAOSTAT-adjusted cattle headcount layers
  ...
  summaries: {
    'eo:bands': [
      {
        name: 'headcount',
        description: 'Estimated cattle headcount per pixel.',
        gsd: 1000
      }
    ],
