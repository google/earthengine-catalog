local id = 'projects/global-pasture-watch/assets/gld-1km/v1/cattle-headcount-faostat_m';
...
{
  id: id,
  title: 'GPW Annual cattle headcount FAOSTAT-adjusted v' + version,
  version: version,

  description: |||
    This dataset provides global cattle headcount from 2000 to 2022 at 1-km spatial resolution.
  ||| + livestock_md,
