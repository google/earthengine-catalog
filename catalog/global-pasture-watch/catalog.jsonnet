...

{
  ...
  links: [
    ...
    ee.link.child_collection('projects_global-pasture-watch_assets_ggpp-30m_v1-1_ugpp_m', base_url),
    ee.link.child_collection('projects_global-pasture-watch_assets_ggpp-10m_v1-beta_nrt', base_url),
