...
{
  id: id,
  title: 'GPW Annual buffalo headcount FAOSTAT-adjusted v' + version,
  version: version,

  description: |||
    This dataset provides global buffalo headcount from 2000 to 2022 at 1-km spatial resolution.
  ||| + livestock_md,
  ...
  summaries: {
    ...
    'gee:visualizations': [
      {
        display_name: 'Headcount (buffalo)',
