...
{
  id: id,
  title: 'GPW Goat Headcount FAOSTAT-adjusted v' + version,
  version: version,

  description: |||
    This dataset provides annual FAOSTAT-adjusted goat headcount layers
  ...
  summaries: {
    'eo:bands': [
      {
        name: 'headcount',
        description: 'Estimated goat headcount per pixel.',
        gsd: 1000
      }
    ],
