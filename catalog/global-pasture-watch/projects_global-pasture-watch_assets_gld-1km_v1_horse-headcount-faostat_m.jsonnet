...
{
  id: id,
  title: 'GPW Horse Headcount FAOSTAT-adjusted v' + version,
  version: version,

  description: |||
    This dataset provides annual FAOSTAT-adjusted horse headcount layers
  ...
  summaries: {
    'eo:bands': [
      {
        name: 'headcount',
        description: 'Estimated horse headcount per pixel.',
        gsd: 1000
      }
    ],
