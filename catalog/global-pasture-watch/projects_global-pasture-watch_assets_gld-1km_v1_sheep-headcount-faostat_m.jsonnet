...
{
  id: id,
  title: 'GPW Sheep Headcount FAOSTAT-adjusted v' + version,
  version: version,

  description: |||
    This dataset provides annual FAOSTAT-adjusted sheep headcount layers
  ...
  summaries: {
    'eo:bands': [
      {
        name: 'headcount',
        description: 'Estimated sheep headcount per pixel.',
        gsd: 1000
      }
    ],
