...

{
  ...
  links: [
    ...
    ee.link.child_collection('WWF_HydroATLAS_v1_Basins_level03', base_url),
    ee.link.child_collection('WWF_HydroATLAS_v1_Basins_level04', base_url),
    ee.link.child_collection('WWF_HydroATLAS_v1_Basins_level05', base_url),
    ee.link.child_collection('WWF_HydroATLAS_v1_Basins_level06', base_url),
    ee.link.child_collection('WWF_HydroATLAS_v1_Basins_level07', base_url),
    ee.link.child_collection('WWF_HydroATLAS_v1_Basins_level08', base_url),
    ee.link.child_collection('WWF_HydroATLAS_v1_Basins_level09', base_url),
    ee.link.child_collection('WWF_HydroATLAS_v1_Basins_level10', base_url),
    ee.link.child_collection('WWF_HydroATLAS_v1_Basins_level11', base_url),
