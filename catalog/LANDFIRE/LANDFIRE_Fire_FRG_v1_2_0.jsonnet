local id = 'LANDFIRE/Fire/FRG/v1_2_0';
...

{
  ...
  id: id,
  title: 'LANDFIRE FRG (Fire Regime Groups) v1.2.0',
  version: '1.4.0',
...
Department of the Interior's Geological Survey (USGS), and The Nature Conservancy.", 'https://landfire.gov/'),
  ...
  summaries: {
    'gee:schema': [
      {
        name: 'FRG_classes',
        description: 'Class values of the fire regime groups.',
        type: ee_const.var_type.double,
      },
      {
        name: 'FRG_names',
        description: 'Descriptive names of the fire regime groups.',
    ...
    'eo:bands': [
      {
        name: 'FRG',
        description: 'Fire Regime Groups',
        'gee:classes': [
          {
            value: 1,
            color: '4cc24a',
            description: '<= 35 Year Fire Return Interval, Low and Mixed Severity',
          },
          {
            value: 2,
            color: '265400',
            description: '<= 35 Year Fire Return Interval, Replacement Severity',
          },
          {
            value: 3,
            color: 'ffff99',
            description: '35 - 200 Year Fire Return Interval, Low and Mixed Severity',
          },
          {
            value: 4,
            color: '8400a8',
            description: '35 - 200 Year Fire Return Interval, Replacement Severity',
          },
          {
            value: 5,
            color: 'ee1e00',
            description: '> 200 Year Fire Return Interval, Any Severity',
          },
          {
            value: 111,
            color: '0000ff',
