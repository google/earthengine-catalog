local id = 'LANDFIRE/Fire/PMS/v1_2_0';
...

{
  ...
  id: id,
  title: 'LANDFIRE PMS (Percent of Mixed-severity Fire) v1.2.0',
  version: '1.4.0',
...
Department of the Interior's Geological Survey (USGS), and The Nature Conservancy.", 'https://landfire.gov/'),
  ...
  summaries: {
    'gee:schema': [
      {
        name: 'PMS_classes',
        description: 'Class values of the  Percent of Mixed-severity Fire.',
        type: ee_const.var_type.double,
      },
      {
        name: 'PMS_names',
        description: 'Descriptive names of Percent of Mixed-severity Fire.',
    ...
    'eo:bands': [
      {
        name: 'PMS',
        description: 'Percent of Mixed-severity Fire',
        'gee:classes': [
          {
            value: 1,
            color: '008200',
