local id = 'LANDFIRE/Fire/PLS/v1_2_0';
...

{
  ...
  id: id,
  title: 'LANDFIRE PLS (Percent Low-severity Fire) v1.2.0',
  version: '1.4.0',
...
Department of the Interior's Geological Survey (USGS), and The Nature Conservancy.", 'https://landfire.gov/'),
  ...
  summaries: {
    'gee:schema': [
      ...
      {
        name: 'PLS_names',
        description: 'Descriptive names of Percent Low-severity Fire.',
    ...
    'eo:bands': [
      {
        name: 'PLS',
        description: 'Percent Low-severity Fire',
        'gee:classes': [
          {
            value: 1,
            color: '008200',
