// Overture Maps - Base: Land
// BigQuery table: bigquery-public-data.overture_maps.land

local id = 'overture-maps/base_land';
...

{
  ...
  'gee:bq_table_name': 'bigquery-public-data.overture_maps.land',
  description: |||
    The Overture Maps Base theme Land layer contains physical representations
    of land surfaces derived primarily from OpenStreetMap features containing
    the natural tag.

    Each land feature includes a subtype (broad category such as forest,
    glacier, grass, wetland) and a class (specific classification such as
    beach, cliff, dune, meadow, peak, valley). The data supports Point,
    ...
    Documentation: [Land Schema](https://docs.overturemaps.org/schema/reference/base/land/)
  ...
  links: ee.standardLinks(subdir, id) + [
    ee.link.license(license.reference),
    {
      ...
      href: 'https://console.cloud.google.com/bigquery?p=bigquery-public-data&d=overture_maps&t=land',
    },
  ],
  'gee:categories': [
  ...
  summaries: {
    'gee:schema': [
      ...
      },
      {
        name: 'class',
        description: |||
          Specific land classification. Possible values include: archipelago,
          bare_rock, beach, cave_entrance, cliff, desert, dune, fell, forest,
          glacier, grass, grassland, heath, hill, island, islet, land, meadow,
          meteor_crater, mountain_range, peak, peninsula, plateau, reef,
          ridge, rock, saddle, sand, scree, scrub, shingle, shrub, shrubbery,
          stone, tree, tree_row, tundra, valley, volcanic_caldera_rim,
          volcano, wetland, wood.
        |||,
      ...
      },
      {
        name: 'elevation',
        description: |||
          Height measurement of the land feature in meters, where applicable.
        |||,
      ...
      },
      {
        name: 'subtype',
        description: |||
          Broad land category. Possible values: crater, desert, forest,
          glacier, grass, land, physical, reef, rock, sand, shrub, tree,
          wetland.
        |||,
        type: ee_const.var_type.string,
      },
      {
        name: 'surface',
        description: |||
          Physical surface material of the land area (e.g., grass, rock,
          sand).
        |||,
        type: ee_const.var_type.string,
      },
    ...
    'gee:visualizations': [
      {
        display_name: 'Overture Maps: Land',
        lookat: {
          lat: 40.7128,
          lon: -74.006,
          zoom: 10,
