local id = 'JRC/GSW1_0/GlobalSurfaceWater';
local successor_id = 'JRC/GSW1_1/GlobalSurfaceWater';
local subdir = 'JRC';
...

{
  ...
  id: id,
  title: 'JRC Global Surface Water Mapping Layers, v1.0 [deprecated]',
  version: '1.0',
  deprecated: true,
  ...
  description: |||
    ...
    surface water over the last 32 years. Areas where water has
