local id = 'JRC/GHSL/P2023A/GHS_SMOD_V2-0';
...

{
  ...
  id: id,
  title: 'GHSL: Degree of Urbanization 1975-2030 V2-0 (P2023A)',
  version: version,
  ...
  description: |||
    ...
    (https://human-settlement.emergency.copernicus.eu/documents/GHSL_Data_Package_2023.pdf?t=1727170839)
  ...
  providers: [
    ee.producer_provider('EC JRC', 'https://human-settlement.emergency.copernicus.eu/ghs_smod2023.php'),
