...

{
  ...
  extent: ee.extent_global('2007-01-01T00:00:00Z', '2023-01-01T00:00:00Z'),
  summaries: {
    gsd: [
      100.0,
    ],
    'eo:bands': [
      {
        name: 'agb',
        description: |||
          Above ground biomass (AGB) is defined as the mass, expressed as
          oven-dry weight of the woody parts (stem, bark, branches and twigs)
