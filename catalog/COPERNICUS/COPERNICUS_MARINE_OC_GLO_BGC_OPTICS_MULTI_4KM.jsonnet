local id = 'COPERNICUS/MARINE/OC_GLO_BGC/OPTICS_MULTI_4KM';
...

{
  ...
  id: id,
  title: 'Global Ocean Colour: Bio-Geo-Chemical, L4, from Satellite Observations, Optics, Multi-Sensor 4KM',
  'gee:type': ee_const.gee_type.image_collection,
  description: template.description + template.optics_multi_description +
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        name: 'BBP',
        description: 'Particulate Backscattering',
        'gee:units': units.inverse_length,
      },
      {
        name: 'BBP_uncertainty',
        description: |||
