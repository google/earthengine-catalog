local id = 'COPERNICUS/MARINE/OC_GLO_BGC/TRANSPARENCY_OLCI_4KM';
...

{
  ...
  id: id,
  title: 'Global Ocean Colour: Bio-Geo-Chemical, L4, from Satellite Observations, Transparency, OLCI, 4KM',
  'gee:type': ee_const.gee_type.image_collection,
  description: template.description + template.transparency_olci_description +
