...

{
  ...
  links: [
    ...
    ee.link.child_collection('COPERNICUS_MARINE_GLOBAL_ANALYSISFORECAST_BGC_001_028_OPTICS', base_url),
    ee.link.child_collection('COPERNICUS_MARINE_GLOBAL_ANALYSISFORECAST_BGC_001_028_PFT', base_url),
    ee.link.child_collection('COPERNICUS_MARINE_GLOBAL_ANALYSISFORECAST_BGC_001_028_PLANKTON', base_url),
    ...
    ee.link.child_collection('COPERNICUS_MARINE_INSITU_MULTI_4KM_ARGO', base_url),
    ee.link.child_collection('COPERNICUS_MARINE_INSITU_MULTI_4KM_DRIFTER', base_url),
    ee.link.child_collection('COPERNICUS_MARINE_INSITU_MULTI_4KM_RADAR_RADIAL', base_url),
    ee.link.child_collection('COPERNICUS_MARINE_INSITU_MULTI_4KM_RADAR_TOTAL', base_url),
    ...
    ee.link.child_collection('COPERNICUS_DEM_GLO30_2024_1', base_url),
  ],
}
