...

{
  ...
  description: insitu.description + |||
    ...
    interval and delivered on an hourly basis. Total velocities are derived
    using an un-weighted least-square fit that maps radial velocities, measured
    by individual measurement stations, onto a Cartesian grid. The final product
    is a map of the zonal and meridional components of the ocean currents on a
    regular grid in the area of overlap of two or more radar stations.
  |||,
