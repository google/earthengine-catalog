...
description: |||
   ...
   is a critical oceanographic product that provides daily, global, and gap-free
   Level-4 (L4) analyses of Sea Surface Salinity (SSS) and Sea Surface Density
   (SSD) at a high resolution of 1/8 degree. This valuable product is generated
   ...
   consistent time series often starting as early as 1993 that includes both
   historical (reprocessed) data and near-real-time updates.
   By delivering these essential climate variables, the dataset is indispensable
   for monitoring the global water cycle, studying changes in ocean circulation
   driven by density variations, and serving as a crucial input for climate
