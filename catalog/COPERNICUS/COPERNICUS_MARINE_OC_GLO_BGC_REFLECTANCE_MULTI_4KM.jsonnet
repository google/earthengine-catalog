local id = 'COPERNICUS/MARINE/OC_GLO_BGC/REFLECTANCE_MULTI_4KM';
...

{
  ...
  id: id,
  title: 'Global Ocean Colour: Bio-Geo-Chemical, L4, from Satellite Observations, Reflectance, Multi-Sensor 4KM',
  'gee:type': ee_const.gee_type.image_collection,
  description: template.description + template.reflectance_multi_description +
  ...
  extent: ee.extent_global('2025-10-01T00:00:00Z', null),
  summaries: {
    gsd: [
      4000.0,
    ],
    'eo:bands': [
      ...
      {
        name: 'RRS555',
        description: 'Remote Sensing Reflectance at 555 nm',
        'gee:units': units.per_steradian,
      },
      {
        name: 'RRS555_uncertainty',
        description: |||
          Remote Sensing Reflectance at 555 nm - The uncertainty as measured in
          hundredths of a percent (e.g., a value of 5000 means 50%).
        |||,
        'gee:units': units.percent,
      },
      {
        name: 'RRS670',
        description: 'Remote Sensing Reflectance at 670 nm',
        'gee:units': units.per_steradian,
      },
      {
        name: 'RRS670_uncertainty',
        description: |||
          Remote Sensing Reflectance at 670 nm - The uncertainty as measured in
          hundredths of a percent (e.g., a value of 5000 means 50%).
        |||,
        'gee:units': units.percent,
      },
