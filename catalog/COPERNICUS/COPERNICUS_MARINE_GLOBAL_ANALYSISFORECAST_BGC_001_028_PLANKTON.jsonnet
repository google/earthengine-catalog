...
local id = 'COPERNICUS/MARINE/GLOBAL_ANALYSISFORECAST_BGC_001_028/PLANKTON';

{
  ...
  id: id,
  title: 'Copernicus Global Ocean Bio-Geo-Chemical Forecast - PLANKTON',
  'gee:type': 'image_collection',
  description: template.description + |||
                    These products are provided on 50 vertical levels with
                    depths ranging from 0.49m to 5727.92m.
                    <br><br> This dataset consists of total zooplankton
                    concentration.
                  |||,
  ...
  summaries: {
    ...
    'eo:bands':
        template.gen_bands('zooc',
                           'Total Zooplankton',
                           units.mmol_per_cubic_meter,
                           template.ALL_DEPTHS),
    'gee:visualizations': [
      {
        display_name: 'Global BGC PLANKTON Forecast - zooc',
        lookat: {
          lat: 73.63,
          lon: -140.5,
          zoom: 2,
  ...
  template.gen_summaries('zooc', 0, 5, template.ALL_DEPTHS),
