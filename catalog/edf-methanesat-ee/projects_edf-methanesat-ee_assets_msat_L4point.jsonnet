...
{
  id: id,
  title: 'MethaneSAT L4 Point Sources MethaneSAT V' + version,
  version: version,
  description: |||
    This early "MethaneSAT" dataset provides high precision data for methane emissions from
    ...
    (see L4 Area Sources MethaneSAT).
    ...
    What this means for the MethaneSAT data: The existing datasets will remain accessible on
