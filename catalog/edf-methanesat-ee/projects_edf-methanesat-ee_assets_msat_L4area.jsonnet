...
{
  id: id,
  title: 'MethaneSAT L4 Area Sources MethaneSAT V' + version,
  version: version,
  description: |||
    *The dispersed area emissions model is still in development and not
    representative of a final product.*

    This early "MethaneSAT" dataset provides high precision data for methane
    ...
    (see L4 Point Sources MethaneSAT).
