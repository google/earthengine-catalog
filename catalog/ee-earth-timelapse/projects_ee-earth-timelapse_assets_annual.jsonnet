...

{
  ...
  description: |||
    ...
    reflectance. Derived spectral indices (such as NDVI) will differ from
    Level-2 Surface Reflectance products and are not recommended for
    quantitative radiometric analysis.
  ...
  'gee:terms_of_use': |||
    ...
    and requires the following attribution:
