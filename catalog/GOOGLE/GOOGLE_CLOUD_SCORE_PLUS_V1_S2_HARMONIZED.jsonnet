...

{
  ...
  description: |||
    ...
    differentiate between "cloud" and "cloud shadow." Instead, QA artifacts are
    ...
    individual pixels with respect to land visibility on a scale of [0, 1]
    ...
    observation, while the `cs_cdf` band respresents the likelihood an observed
    ...
    system:index as the individual Sentinel-2 L1C assets from which they
    were produced such that Cloud Score+ bands can be linked to source images
    based on their shared system:index.
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        name: 'cs',
        description: 'Pixel quality score',
        gsd: 10,
        'gee:units': units.dimensionless,
      },
      {
        name: 'cs_cdf',
        description: 'Estimated likelihood of an unoccluded observation',
        gsd: 10,
        'gee:units': units.dimensionless,
      },
    ],

    band_name_1: {minimum: 0, maximum: 1, 'gee:estimated_range': true},
    band_name_2: {minimum: 0, maximum: 1, 'gee:estimated_range': true},
    band_name_3: {minimum: 0, maximum: 1, 'gee:estimated_range': true},
    band_name_4: {minimum: 0, maximum: 1, 'gee:estimated_range': true},

    // One or more band visualizations.
    'gee:visualizations': [
      {
        display_name: 'Cloud Score+ (cs_cdf)',
    ...
    'gee:schema': [
      ...
      },
      {
        ...
        description:
          'Fraction of tiles for which full history was not available.',
  ...
  'sci:doi': '10.1109/CVPRW59228.2023.00206',
