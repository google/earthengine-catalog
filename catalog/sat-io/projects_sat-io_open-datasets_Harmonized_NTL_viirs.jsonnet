local id = 'projects/sat-io/open-datasets/Harmonized_NTL/viirs';
local subdir = 'sat-io';
...

{
  ...
  id: id,
  title: 'Harmonized Global Night Time Lights VIIRS',
  ...
  extent: ee.extent_global('2013-01-01T00:00:00Z', '2021-12-31T00:00:00Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'country',
    ...
    'gee:visualizations': [
      {
        display_name: 'Harmonized DN Night Time Lights VIIRS',
        lookat: {
          lat: 48.2875,
          lon: 31.175,
          zoom: 5,
