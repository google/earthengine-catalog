local id = 'USGS/WBD/2017/HUC12';
local subdir = 'USGS/WBD';
...

{
  ...
  id: id,
  title: 'HUC12: USGS Watershed Boundary Dataset of Subwatersheds',
    ...
    'gee:schema': [
      ...
      },
      {
        ...
        description: |||
          ...
          normal flow conditions (always empty)
        |||,
        type: ee_const.var_type.string,
      },
      {
        name: 'tohuc',
        description: |||
          Code for the 12-digit hydrologic unit that is downstream
          from and naturally receives the majority of the flow from this
          unit
        |||,
        type: ee_const.var_type.string,
      },
