...

{
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        ...
        description: 'TODO: describe annual_herbaceous_break_point',
        'gee:units': units_counts,
      },
      {
        name: 'bare_ground_break_point',
        description: 'TODO: describe bare_ground_break_point',
        'gee:units': units_counts,
      },
      {
        name: 'herbaceous_break_point',
        description: 'TODO: describe herbaceous_break_point',
        'gee:units': units_counts,
      },
      {
        name: 'litter_break_point',
        description: 'TODO: describe litter_break_point',
        'gee:units': units_counts,
      },
      {
        name: 'sagebrush_break_point',
        description: 'TODO: describe sagebrush_break_point',
        'gee:units': units_counts,
      },
      {
        name: 'shrub_break_point',
        description: 'TODO: describe shrub_break_point',
        'gee:units': units_counts,
      },
      {
        name: 'non_sagebrush_shrub_break_point',
        description: 'TODO: describe non_sagebrush_shrub_break_point',
        'gee:units': units_counts,
      },
      {
        name: 'perennial_herbaceous_break_point',
        description: 'TODO: describe perennial_herbaceous_break_point',
        'gee:units': units_counts,
      },
      {
        name: 'tree_break_point',
        description: 'TODO: describe tree_break_point',
        'gee:units': units_counts,
      },
      {
        name: 'annual_herbaceous_linear_model_slope',
        description: 'TODO: describe annual_herbaceous_linear_model_slope',
        'gee:units': units_centipercent_per_year,
      },
      {
        name: 'bare_ground_linear_model_slope',
        description: 'TODO: describe bare_ground_linear_model_slope',
        'gee:units': units_centipercent_per_year,
      },
      {
        name: 'herbaceous_linear_model_slope',
        description: 'TODO: describe herbaceous_linear_model_slope',
        'gee:units': units_centipercent_per_year,
      },
      {
        name: 'litter_linear_model_slope',
        description: 'TODO: describe litter_linear_model_slope',
        'gee:units': units_centipercent_per_year,
      },
      {
        name: 'sagebrush_linear_model_slope',
        description: 'TODO: describe sagebrush_linear_model_slope',
        'gee:units': units_centipercent_per_year,
      },
      {
        name: 'shrub_linear_model_slope',
        description: 'TODO: describe shrub_linear_model_slope',
        'gee:units': units_centipercent_per_year,
      },
      {
        name: 'non_sagebrush_shrub_linear_model_slope',
        description: 'TODO: describe non_sagebrush_shrub_linear_model_slope',
        'gee:units': units_centipercent_per_year,
      },
      {
        name: 'perennial_herbaceous_linear_model_slope',
        description: 'TODO: describe perennial_herbaceous_linear_model_slope',
        'gee:units': units_centipercent_per_year,
      },
      {
        name: 'tree_linear_model_slope',
        description: 'TODO: describe tree_linear_model_slope',
        'gee:units': units_centipercent_per_year,
      },
      {
        name: 'annual_herbaceous_linear_model_pvalue',
        description: 'TODO: describe annual_herbaceous_linear_model_pvalue',
        'gee:units': units_confidence,
      },
      {
        name: 'bare_ground_linear_model_pvalue',
        description: 'TODO: describe bare_ground_linear_model_pvalue',
        'gee:units': units_confidence,
      },
      {
        name: 'herbaceous_linear_model_pvalue',
        description: 'TODO: describe herbaceous_linear_model_pvalue',
        'gee:units': units_confidence,
      },
      {
        name: 'litter_linear_model_pvalue',
        description: 'TODO: describe litter_linear_model_pvalue',
        'gee:units': units_confidence,
      },
      {
        name: 'sagebrush_linear_model_pvalue',
        description: 'TODO: describe sagebrush_linear_model_pvalue',
        'gee:units': units_confidence,
      },
      {
        name: 'shrub_linear_model_pvalue',
        description: 'TODO: describe shrub_linear_model_pvalue',
        'gee:units': units_confidence,
      },
      {
        name: 'non_sagebrush_shrub_linear_model_pvalue',
        description: 'TODO: describe non_sagebrush_shrub_linear_model_pvalue',
        'gee:units': units_confidence,
      },
      {
        name: 'perennial_herbaceous_linear_model_pvalue',
        description: 'TODO: describe perennial_herbaceous_linear_model_pvalue',
        'gee:units': units_confidence,
      },
      {
        name: 'tree_linear_model_pvalue',
        description: 'TODO: describe tree_linear_model_pvalue',
        'gee:units': units_confidence,
      },
      {
        name: 'annual_herbaceous_most_recent_break_point',
        description: 'TODO: describe annual_herbaceous_most_recent_break_point',
        'gee:units': units_year,
      },
      {
        name: 'bare_ground_most_recent_break_point',
        description: 'TODO: describe bare_ground_most_recent_break_point',
        'gee:units': units_year,
      },
      {
        name: 'herbaceous_most_recent_break_point',
        description: 'TODO: describe herbaceous_most_recent_break_point',
        'gee:units': units_year,
      },
      {
        name: 'litter_most_recent_break_point',
        description: 'TODO: describe litter_most_recent_break_point',
        'gee:units': units_year,
      },
      {
        name: 'sagebrush_most_recent_break_point',
        description: 'TODO: describe sagebrush_most_recent_break_point',
        'gee:units': units_year,
      },
      {
        name: 'shrub_most_recent_break_point',
        description: 'TODO: describe shrub_most_recent_break_point',
        'gee:units': units_year,
      },
      {
        name: 'non_sagebrush_shrub_most_recent_break_point',
        description: 'TODO: describe non_sagebrush_shrub_most_recent_break_point',
        'gee:units': units_year,
      },
      {
        name: 'perennial_herbaceous_most_recent_break_point',
        description: 'TODO: describe perennial_herbaceous_most_recent_break_point',
        'gee:units': units_year,
      },
      {
        name: 'tree_most_recent_break_point',
        description: 'TODO: describe tree_most_recent_break_point',
        'gee:units': units_year,
      },
      {
        name: 'total_change_intensity_index',
        description: 'TODO: describe total_change_intensity_index',
        'gee:units': units_class,
      },
    ],
    'gee:visualizations': [
      {
        display_name: 'sagebrush break point',
        lookat: {
          lat: 38,
          lon: -114,
          zoom: 6,
    ...
    annual_herbaceous_break_point: {
      minimum: -99999,  // TODO: Replace all -99999 with the correct values
      maximum: 99999,  // TODO: Replace all 99999 with the correct values
