local id = 'NOAA/GOES/18/FDCF';
local subdir = 'NOAA/GOES';
...
{
  'gee:skip_indexing': true,  // TODO: Enable when available.
  ...
  id: id,
  title: 'GOES-18 FDCF Series ABI Level 2 Fire/Hot Spot Characterization Full Disk',
  ...
  links: ee.standardLinks(subdir, id) + [
    {
      ...
      href: 'https://console.cloud.google.com/storage/browser/gcp-public-data-goes-18/ABI-L2-FDCF/',
    },
  ],
  keywords: [
    'abi',
  ...
  extent: ee.extent_global('2018-08-27T00:00:00Z', null),
  summaries: {
    gsd: [
      2000.0,
    ],
