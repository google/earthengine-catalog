  ...
  summaries: {
    ...
    'eo:bands': [
      ...
      },
      {
        ...
        description:
          'Canopy water evaporation 3 hour average at ground or ' +
      ...
      },
      {
        ...
        description:
          'Categorical Rain 3 hour average at ground or water surface for ' +
          '03 forecast',
      },
      {
        name: 'Categorical_Freezing_Rain_surface_3_Hour_Average',
        description:
          'Categorical freezing rain 3 hour average at ground or ' +
          'water surface for 03 forecast',
      },
      {
        name: 'Categorical_Ice_Pellets_surface_3_Hour_Average',
        description:
          'Categorical ice pellets 3 hour average at ground or ' +
          'water surface for 03 forecast',
      },
      {
        name: 'Categorical_Snow_surface_3_Hour_Average',
        description:
          'Categorical snow 3 hour average at ground or water surface ' +
          'for 03 forecast',
      },
      {
        name: 'Clear_Sky_Downward_Long_Wave_Flux_surface_3_Hour_Average',
        description:
          'Clear Sky Downward Long Wave Flux 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Clear Sky Downward Solar Flux 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Clear Sky Upward Long Wave Flux 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Clear Sky Upward Solar Flux 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Clear Sky UV-B Downward Solar Flux 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
      ...
      },
      {
        ...
        description:
          'Cloud work function 3 hour average at entire atmosphere layer for ' +
          '03 forecast',
      ...
      },
      {
        ...
        description:
          'Convective available potential energy at ground or water surface ' +
          'for 00 and 03 forecast',
        'gee:units': units.joules_per_kg,
      },
      {
        name: 'Convective_available_potential_energy_pressure_difference_layer',
        description:
          'Convective available potential energy at specified ' +
          'pressure difference from ground to level layer for 03 forecast',
        'gee:units': units.joules_per_kg,
      },
      {
        name: 'Convective_Precipitation_Rate_surface_3_Hour_Average',
        description:
          'Convective precipitation rate 3 hour average at ground or ' +
          'water surface for 03 forecast',
      ...
      },
      {
        ...
        description:
          'Convective precipitation 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.area_density,
      },
      {
        ...
        description:
          'Direct evaporation from bare soil surface 3 hour average at ' +
      ...
      },
      {
        ...
        description:
          'Downward Long-Wave Rad. Flux at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Downward Long-Wave Rad. Flux  3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Downward Short-Wave Radiation Flux at ground or water surface ' +
          'for 00 and 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Downward Short-Wave Radiation Flux 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Downward Short-Wave Radiation Flux atmosphere top 3 hour average ' +
          'at ground or water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        name: 'Exchange_Coefficient_surface',
        description:
           'Exchange Coefficient at ground or water surface for ' +
           '00 and 03 forecast',
      ...
      },
      {
        ...
        description:
          'Frictional Velocity at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.velocity_si,
      },
      {
      ...
      },
      {
        ...
        description:
          'Land cover (0 = sea, 1 = land) at ground or water surface for ' +
          '00 and 03 forecast',
      ...
      },
      {
        ...
        description:
          'Latent heat net flux at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
      ...
      },
      {
        ...
        description:
          'Liquid Volumetric Soil Moisture (non Frozen) 5 cm depth below ' +
          'land surface layer',
      },
      {
        name: 'Liquid_Volumetric_Soil_Moisture_non_Frozen_depth_below_surface_layer_25_cm',
        description:
          'Liquid Volumetric Soil Moisture (non Frozen) 25 cm depth below ' +
          'land surface layer',
      },
      {
      ...
      },
      {
        ...
        description:
           'Liquid Volumetric Soil Moisture (non Frozen) 150 cm depth ' +
           'below land surface layer',
      },
      {
        name: 'Maximum_temperature_height_above_ground_3_Hour_Interval',
        description:
          'Maximum temperature for 3 Hour Interval at specified height level ' +
          'above ground for 03 forecast',
        'gee:units': units.kelvin,
      },
      {
        name: 'Minimum_temperature_height_above_ground_3_Hour_Interval',
        description:
          'Minimum temperature for 3 Hour Interval at specified height level ' +
          'above ground for 03 forecast',
        'gee:units': units.kelvin,
      },
      {
        ...
        description:
          'Maximum specific humidity for 3 Hour Interval at 2m specified ' +
          'height level above ground for 03 forecast',
        'gee:units': units.mass_fraction,
      },
      {
        name: 'Minimum_specific_humidity_at_2m_height_above_ground_3_Hour_Interval',
        description:
          'Minimum specific humidity for 3 Hour Interval at 2m specified ' +
          'height level above ground for 03 forecast',
        'gee:units': units.mass_fraction,
      },
      {
        ...
        description:
          'Momentum flux, u-component 3 hour average at ground or ' +
          'water surface for 03 forecast',
      ...
      },
      {
        ...
        description:
          'Plant Canopy Surface Water at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.area_density,
      },
      {
        ...
        description:
          'Planetary Boundary Layer Height at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.meter,
      },
      {
        ...
        description:
          'Potential Evaporation Rate at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Potential Evaporation Rate 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Precipitable rate 3 hour average at ground or water surface for ' +
          '03 forecast',
        'gee:units': units.rainfall_rate_kg_per_m2_per_s,
      },
      {
        ...
        description:
          'Precipitable water at entire atmosphere layer for ' +
          '00 and 03 forecast',
        'gee:units': units.area_density,
      },
      {
        ...
        description:
          'Precipitable water at specified pressure difference from ground ' +
          'to level layer for 00 forecast',
        'gee:units': units.area_density,
      },
      {
        name: 'Pressure_msl',
      ...
      },
      {
        ...
        description:
          'Sensible heat net flux at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Sensible heat net flux 3 hour average at ground or water surface ' +
          'for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Snow cover 3 hour average at ground or water surface for ' +
          '03 forecast',
        'gee:units': units.percent,
      },
      {
      ...
      },
      {
        ...
        description:
          'Soil moisture content at Depth below land surface layer for ' +
          '00 and 03 forecast',
        'gee:units': units.area_density,
      },
      {
        ...
        // TODO(schwehr): Use gee:classes to describe the 9 types.
        // 9 is ice.
      },
      {
        name: 'Storm_Surface_Runoff_surface_3_Hour_Accumulation',
        description:
          'Storm surface runoff 3 hour accumulation at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.area_density,
      },
      {
        ...
        description:
          'Sublimation (evaporation from snow) 3 hour average at ' +
          'ground or water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Specific humidity at Specified height level above ground for ' +
          '00 forecast',
        'gee:units': units.mass_fraction,
      },
      {
        ...
        description:
          'Surface Lifted Index at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.kelvin,
      },
      {
      ...
      },
      {
        ...
        description:
          'Surface Slope Type at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': 'index',
      },
      {
        ...
        description:
          'Temperature 5cm depth below land surface layer for ' +
          '00 and 03 forecast',
        'gee:units': units.kelvin,
      },
      {
      ...
      },
      {
        ...
        description:
          'Temperature 70 cm depth below land surface layer for ' +
          '00 and 03 forecast',
        'gee:units': units.kelvin,
      },
      {
        ...
        description:
          'Temperature 150cm depth below land surface layer for ' +
          '00 and 03 forecast',
        'gee:units': units.kelvin,
      },
      {
      ...
      },
      {
        ...
        description:
          'Total precipitation 3 hour average at ground or water surface for ' +
          '03 forecast',
        'gee:units': units.area_density,
      },
      {
        ...
        description:
          'Transpiration surface 3 hour average at ground or water surface ' +
          'for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Upward Long-Wave Rad. Flux at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Upward Long-Wave Radiation Flux 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Upward Long-Wave Radiation Flux 3 hour average at nominal ' +
          'top of the atmosphere for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        name: 'Upward_Short-Wave_Radiation_Flux_surface',
        description:
          'Upward Short-Wave Radiation Flux at ground or water surface for ' +
          '00 and 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Upward Short-Wave Radiation Flux 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'Upward Short-Wave Radiation Flux 3 hour average at nominal ' +
          'top of the atmosphere for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
        ...
        description:
          'UV-B Downward Solar Flux 3 hour average at ground or ' +
          'water surface for 03 forecast',
        'gee:units': units.watt_per_meter_squared,
      },
      {
      ...
      },
      {
        ...
        description:
          'Volumetric soil moisture content 5cm below surface layer for ' +
          '00 and 03 forecast',
      ...
      },
      {
        ...
        description:
          'Volumetric soil moisture content 25cm below surface layer for ' +
          '00 and 03 forecast',
        'gee:units': units.unspecified_fraction,
      },
      {
        ...
        description:
          'Volumetric soil moisture content 70cm below surface layer for ' +
          '00 and 03 forecast',
        'gee:units': units.unspecified_fraction,
      },
      {
        ...
        description:
          'Volumetric soil moisture content 150cm below surface layer for ' +
          '00 and 03 forecast',
        'gee:units': units.unspecified_fraction,
      },
      {
        ...
        description:
          'Water equivalent of accumulated snow depth at ground or ' +
          'water surface for 00 and 03 forecast',
        'gee:units': units.area_density,
      },
      {
        name: 'Water_runoff_surface_3_Hour_Accumulation',
        description:
          'Water runoff 3 hour accumulation at ground or water surface for ' +
          '03 forecast',
        'gee:units': units.area_density,
      },
    ],
    'gee:visualizations': [
      {
        ...
        lookat: {lon: -88.6, lat: 26.4, zoom: 2},
        image_visualization: {
          band_vis: {
            min: [192],
            max: [339],
    ...
    'u-component_of_wind_hybrid': {
      minimum: -47.24, maximum: 44.33, 'gee:estimated_range': true},
    'v-component_of_wind_hybrid': {
      minimum: -45.45, maximum: 46.36, 'gee:estimated_range': true},
    Albedo_surface_3_Hour_Average: {
      minimum: 0.0, maximum: 91.6, 'gee:estimated_range': true},
    Canopy_water_evaporation_surface_3_Hour_Average: {
      minimum: 0, maximum: 746, 'gee:estimated_range': true},
    Categorical_Rain_surface: {
      minimum: 0, maximum: 1, 'gee:estimated_range': true},
    ...
    Clear_Sky_Downward_Long_Wave_Flux_surface_3_Hour_Average: {
      minimum: 56, maximum: 483, 'gee:estimated_range': true},
    Clear_Sky_Downward_Solar_Flux_surface_3_Hour_Average: {
      minimum: 0, maximum: 1142, 'gee:estimated_range': true},
    Clear_Sky_Upward_Long_Wave_Flux_surface_3_Hour_Average: {
      minimum: 78, maximum: 698, 'gee:estimated_range': true},
    Clear_Sky_Upward_Solar_Flux_atmosphere_top_3_Hour_Average: {
      minimum: 0, maximum: 767, 'gee:estimated_range': true},
    'Clear_sky_UV-B_Downward_Solar_Flux_surface_3_Hour_Average': {
      minimum: 0.0, maximum: 24.77, 'gee:estimated_range': true},
    Cloud_water_entire_atmosphere_single_layer: {
      minimum: 0, maximum: 19, 'gee:estimated_range': true},
    Cloud_Work_Function_entire_atmosphere_single_layer_3_Hour_Average: {
      minimum: 0, maximum: 5791, 'gee:estimated_range': true},
    Convective_available_potential_energy_surface: {
      minimum: 0, maximum: 6069, 'gee:estimated_range': true},
    Convective_available_potential_energy_pressure_difference_layer: {
      minimum: 0, maximum: 5559, 'gee:estimated_range': true},
    Convective_Precipitation_Rate_surface_3_Hour_Average: {
      minimum: 0.0, maximum: 0.002, 'gee:estimated_range': true},
    Convective_precipitation_surface_3_Hour_Accumulation: {
      minimum: 0.0, maximum: 19.2, 'gee:estimated_range': true},
    Direct_Evaporation_from_Bare_Soil_surface_3_Hour_Average: {
      minimum: 0, maximum: 767, 'gee:estimated_range': true},
    'Downward_Long-Wave_Radp_Flux_surface': {
      minimum: 60, maximum: 530, 'gee:estimated_range': true},
    'Downward_Long-Wave_Radp_Flux_surface_3_Hour_Average': {
      minimum: 60, maximum: 508, 'gee:estimated_range': true},
    'Downward_Short-Wave_Radiation_Flux_surface': {
      minimum: 0, maximum: 1224, 'gee:estimated_range': true},
    'Downward_Short-Wave_Radiation_Flux_surface_3_Hour_Average': {
      minimum: 0, maximum: 1142, 'gee:estimated_range': true},
    'Downward_Short-Wave_Radiation_Flux_atmosphere_top_3_Hour_Average': {
      minimum: 0, maximum: 1382, 'gee:estimated_range': true},
    Exchange_Coefficient_surface: {
      minimum: 0.0, maximum: 0.69, 'gee:estimated_range': true},
    Frictional_Velocity_surface: {
      minimum: 0.002, maximum: 3.5, 'gee:estimated_range': true},
    Ground_Heat_Flux_surface: {
      minimum: -459, maximum: 683, 'gee:estimated_range': true},
    Ground_Heat_Flux_surface_3_Hour_Average: {
      minimum: -170, maximum: 538, 'gee:estimated_range': true},
    Ice_cover_surface: {
      minimum: 0, maximum: 1, 'gee:estimated_range': true},
    Ice_thickness_surface: {
      minimum: 0.0, maximum: 4.76, 'gee:estimated_range': true},
    Land_cover_0__sea_1__land_surface: {
      minimum: 0, maximum: 1, 'gee:estimated_range': true},
    Latent_heat_net_flux_surface: {
      minimum: -399, maximum: 1675, 'gee:estimated_range': true},
    Latent_heat_net_flux_surface_3_Hour_Average: {
      minimum: -305, maximum: 1250, 'gee:estimated_range': true},
    Liquid_Volumetric_Soil_Moisture_non_Frozen_depth_below_surface_layer_5_cm: {
      minimum: 0.03, maximum: 1.0, 'gee:estimated_range': true},
    Liquid_Volumetric_Soil_Moisture_non_Frozen_depth_below_surface_layer_25_cm: {
      minimum: 0.028, maximum: 1.0, 'gee:estimated_range': true},
    ...
    Maximum_temperature_height_above_ground_3_Hour_Interval: {
      minimum: 201.39, maximum: 327.7, 'gee:estimated_range': true},
    Minimum_temperature_height_above_ground_3_Hour_Interval: {
      minimum: 201.0, maximum: 321.89, 'gee:estimated_range': true},
    Maximum_specific_humidity_at_2m_height_above_ground_3_Hour_Interval: {
      minimum: 0.0, maximum: 0.036, 'gee:estimated_range': true},
    Minimum_specific_humidity_at_2m_height_above_ground_3_Hour_Interval: {
      minimum: 0.0, maximum: 0.024, 'gee:estimated_range': true},
    'Momentum_flux_u-component_surface_3_Hour_Average': {
      minimum: -6.56, maximum: 8.25, 'gee:estimated_range': true},
    'Momentum_flux_v-component_surface_3_Hour_Average': {
      minimum: -6.17, maximum: 7.22, 'gee:estimated_range': true},
    Plant_Canopy_Surface_Water_surface: {
      minimum: 0.0, maximum: 0.5, 'gee:estimated_range': true},
    Planetary_Boundary_Layer_Height_surface: {
      minimum: 17, maximum: 6590, 'gee:estimated_range': true},
    Potential_Evaporation_Rate_surface: {
      minimum: -150, maximum: 5617, 'gee:estimated_range': true},
    Potential_Evaporation_Rate_surface_3_Hour_Average: {
      minimum: -120, maximum: 5263, 'gee:estimated_range': true},
    Precipitation_rate_surface_3_Hour_Average: {
      minimum: 0.0, maximum: 0.022, 'gee:estimated_range': true},
    Precipitable_water_entire_atmosphere_single_layer: {
      minimum: -0.6, maximum: 99.09, 'gee:estimated_range': true},
    Precipitable_water_pressure_difference_layer: {
      minimum: 0.0, maximum: 7.94, 'gee:estimated_range': true},
    Pressure_msl: {
      minimum: 92406.39, maximum: 106907.89, 'gee:estimated_range': true},
    Pressure_reduced_to_MSL_msl: {
      minimum: 92492.8, maximum: 106667.79, 'gee:estimated_range': true},
    Pressure_surface: {
      minimum: 48110, maximum: 105600, 'gee:estimated_range': true},
    Relative_humidity_entire_atmosphere_single_layer: {
      minimum: 0, maximum: 96, 'gee:estimated_range': true},
    Sensible_heat_net_flux_surface: {
      minimum: -1582, maximum: 2500, 'gee:estimated_range': true},
    Sensible_heat_net_flux_surface_3_Hour_Average: {
      minimum: -977, maximum: 1202, 'gee:estimated_range': true},
    Snow_Cover_surface_3_Hour_Average: {
      minimum: 0, maximum: 100, 'gee:estimated_range': true},
    Snow_depth_surface: {
      minimum: 0.0, maximum: 4.55, 'gee:estimated_range': true},
    Snow_Phase_Change_Heat_Flux_surface_3_Hour_Average: {
      minimum: -405, maximum: 911, 'gee:estimated_range': true},
    Soil_moisture_content_depth_below_surface_layer: {
      minimum: 62.01, maximum: 2000.05, 'gee:estimated_range': true},
    Soil_type_surface: {
      minimum: 1, maximum: 9, 'gee:estimated_range': true},
    Storm_Surface_Runoff_surface_3_Hour_Accumulation: {
      minimum: 0.0, maximum: 193.12, 'gee:estimated_range': true},
    Sublimation_evaporation_from_snow_surface_3_Hour_Average: {
      minimum: 0, maximum: 742, 'gee:estimated_range': true},
    Specific_humidity_height_above_ground: {
      minimum: 0.001, maximum: 0.036, 'gee:estimated_range': true},
    Surface_Lifted_Index_surface: {
      minimum: -15.8, maximum: 57.2, 'gee:estimated_range': true},
    Surface_roughness_surface: {
      minimum: 0.0, maximum: 2.7, 'gee:estimated_range': true},
    Surface_Slope_Type_surface: {
      minimum: 1, maximum: 9, 'gee:estimated_range': true},
    Temperature_depth_below_surface_layer_5_cm: {
      minimum: 219.127, maximum: 323.104, 'gee:estimated_range': true},
    Temperature_depth_below_surface_layer_25_cm: {
      minimum: 220.288, maximum: 313.299, 'gee:estimated_range': true},
    Temperature_depth_below_surface_layer_70_cm: {
      minimum: 218.704, maximum: 310.007, 'gee:estimated_range': true},
    Temperature_depth_below_surface_layer_150_cm: {
      minimum: 218.925, maximum: 307.662, 'gee:estimated_range': true},
    Temperature_height_above_ground: {
      minimum: 201.17, maximum: 325.763, 'gee:estimated_range': true},
    Temperature_surface: {
      minimum: 192.569, maximum: 339.173, 'gee:estimated_range': true},
    Total_cloud_cover_convective_cloud: {
      minimum: 0, maximum: 100, 'gee:estimated_range': true},
    Total_ozone_entire_atmosphere_single_layer: {
      minimum: 177.0, maximum: 571.4, 'gee:estimated_range': true},
    Total_precipitation_surface_3_Hour_Accumulation: {
      minimum: 0, maximum: 239, 'gee:estimated_range': true},
    Transpiration_surface_3_Hour_Average: {
      minimum: 0, maximum: 680, 'gee:estimated_range': true},
    'Upward_Long-Wave_Radp_Flux_surface': {
      minimum: 135, maximum: 611, 'gee:estimated_range': true},
    'Upward_Long-Wave_Radp_Flux_surface_3_Hour_Average': {
      minimum: 78, maximum: 703, 'gee:estimated_range': true},
    'Upward_Long-Wave_Radp_Flux_atmosphere_top_3_Hour_Average': {
      minimum: 69, maximum: 384, 'gee:estimated_range': true},
    'Upward_Short-Wave_Radiation_Flux_surface': {
      minimum: 0, maximum: 869, 'gee:estimated_range': true},
    'Upward_Short-Wave_Radiation_Flux_surface_3_Hour_Average': {
      minimum: 0, maximum: 806, 'gee:estimated_range': true},
    'Upward_Short-Wave_Radiation_Flux_atmosphere_top_3_Hour_Average': {
      minimum: 0, maximum: 1049, 'gee:estimated_range': true},
    'UV-B_Downward_Solar_Flux_surface_3_Hour_Average': {
      minimum: 0.0, maximum: 24.7, 'gee:estimated_range': true},
    Vegetation_surface: {
      minimum: 0, maximum: 99, 'gee:estimated_range': true},
    Vegetation_Type_surface: {
      minimum: 1, maximum: 13, 'gee:estimated_range': true},
    ...
    Water_equivalent_of_accumulated_snow_depth_surface: {
      minimum: 0.0, maximum: 458.82, 'gee:estimated_range': true},
