...

{
  ...
  summaries: {
    ...
    'eo:bands': [
      {
        name: 'cld_emiss_acha',
        description: 'Cloud emissivity at 11μm, determined from ACHA (CDR variable)',
      ...
      {
        name: 'cld_opd_acha',
        description: 'Cloud optical depth at 0.65μm, determined from ACHA',
        center_wavelength: 0.65,
        'gee:scale': 0.03228346,
        'gee:offset': 3.9,
        'gee:wavelength': '0.65μm',
      },
      {
        name: 'cld_opd_dcomp',
        description: 'Cloud optical depth at 0.65μm, determined from DCOMP (CDR variable)',
        center_wavelength: 0.65,
      ...
      },
      {
        ...
        description: 'Uncertainty in the cloud optical depth at 0.65μm, determined from DCOMP',
        'gee:scale': 0.002444532,
        'gee:offset': 79.9,
      },
      {
      ...
      },
      {
        ...
        description: 'Cloud transmission at 0.65μm from DCOMP',
        center_wavelength: 0.65,
        'gee:scale': 0.003937008,
        'gee:offset': 0.5,
        'gee:wavelength': '0.65μm',
      ...
      {
        name: 'refl_0_65um',
        description: 'Top of atmosphere reflectance 0.65μm (CDR variable)',
        center_wavelength: 0.65,
      ...
      },
      {
        ...
        description: 'Instrument counts for the 0.65μm channel',
      },
      {
        name: 'refl_0_65um_stddev_3x3',
        description: 'Standard deviation of the 0.63μm reflectance computed over\na 3x3 pixel array',
        'gee:scale': 0.07874016,
        'gee:offset': 10.0,
      },
      {
        name: 'refl_0_86um',
        description: 'Top of atmosphere reflectance at 0.86μm (CDR variable)',
        center_wavelength: 0.86,
        'gee:scale': 0.001861629,
        'gee:offset': 59.0,
        'gee:wavelength': '0.86μm',
      },
      {
        name: 'refl_0_86um_counts',
        description: 'Instrument counts for the 0.86μm channel',
      },
      {
        name: 'refl_1_60um',
        description: 'Top of atmosphere reflectance at 1.60μm (CDR variable)',
        center_wavelength: 1.6,
        'gee:scale': 0.001861629,
        'gee:offset': 59.0,
        'gee:wavelength': '1.60μm',
      },
      {
        name: 'refl_1_60um_counts',
        description: 'Instrument counts for the 1.60μm channel',
      },
      {
        name: 'refl_3_75um',
        description: 'Top of atmosphere reflectance at 3.75μm (CDR variable)',
