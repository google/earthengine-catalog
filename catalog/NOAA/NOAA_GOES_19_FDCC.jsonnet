...

{
  ...
  keywords: [
    ...
    'fire',
    'goes',
    // TODO - b/402751929: Uncomment once we have another instance of these tags
    // (aka we add the remaining GOES-19 datasets)
    // 'goes_19',
    // 'goes_u',
    'goes_east',
    'hotspot',
  ...
  extent: ee.extent(-180.0, 14.57, 180.0, 53.51, '2025-04-04T00:00:00Z', null),
  summaries: {
    gsd: [
      2000.0,
    ],
