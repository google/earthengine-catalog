...
local version_table = import '../NASA/templates/VIIRS_VNP13A1_versions.libsonnet';
...

{
  ...
  providers: [
    ee.producer_provider('NASA LP DAAC at the USGS EROS Center', 'https://doi.org/10.5067/VIIRS/VNP13A1.001'),
