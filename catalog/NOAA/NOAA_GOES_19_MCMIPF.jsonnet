...

{
  ...
  id: id,
  title: 'GOES-19 MCMIPF Series ABI Level 2 Cloud and Moisture Imagery Full Disk',
  ...
  links: ee.standardLinks(subdir, id) + [
    {
      ...
      href: 'https://console.cloud.google.com/storage/browser/gcp-public-data-goes-19/ABI-L2-MCMIPF/',
    },
  ],
