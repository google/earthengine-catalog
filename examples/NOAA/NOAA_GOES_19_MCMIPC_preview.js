...
var collection = 'NOAA/GOES/19/MCMIPC/';
var imageName = '2025097161117300000';
var assetId = collection + imageName;
var imageScaled = applyScaleAndOffset(assetId);
Map.addLayer(imageScaled, goesRgbViz);
var image = imageScaled.visualize(goesRgbViz);
