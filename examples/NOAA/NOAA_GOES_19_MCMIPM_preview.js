...
var bothDomains = ee.ImageCollection([domain1_col.first(), domain2_col.first()]).mosaic();

var image = bothDomains.visualize(goesRgbViz);
...
var yMin = 20;
var yMax = 50;
Map.setCenter((xMin + xMax) / 2, (yMin + yMax) / 2, 3);
var degrees = 5;
var areaOfInterest = ee.Geometry.Rectangle(
    [xMin - degrees, yMin, xMax + degrees, yMax], null,  false);
