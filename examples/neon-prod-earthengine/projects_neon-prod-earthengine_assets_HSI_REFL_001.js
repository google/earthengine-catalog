...
print('NEON Directional Reflectance Images:');
print(refl001.aggregate_array('system:index'));
...
var reflGRSM_2017 = refl001_2017.filter('NEON_SITE == "GRSM"').first();
...
Map.centerObject(reflGRSM_2017, 14);