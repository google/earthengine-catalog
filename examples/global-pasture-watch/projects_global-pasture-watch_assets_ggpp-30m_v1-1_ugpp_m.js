...
var ugpp = ee.ImageCollection(
    "projects/global-pasture-watch/assets/ggpp-30m/v1-1/ugpp_m"
)

var ugpp2025 = ugpp.filterDate('2025-01-01', '2026-01-01').first();
Map.addLayer(ugpp2025, ugppVis, 'Uncalibrated GPP (2025)');
