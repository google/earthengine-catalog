...
var img = ee.Image('projects/edf-methanesat-ee/assets/public-preview/L4area_v2/MSAT_L4_COG_GEE_c04770550_p2225_v00005001_20241122T204733Z_204805Z');
...
var preppedImg = prepColorPalette(img);

// Visualization
var imgVis = preppedImg.visualize(fluxVisParams);

// Background
var background = ee.Image.rgb(256, 256, 256).rename('vis-red', 'vis-green', 'vis-blue');
var imageWithBackground = background.blend(imgVis);
