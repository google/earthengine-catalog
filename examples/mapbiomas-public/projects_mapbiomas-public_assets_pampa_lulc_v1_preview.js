/**
  MapBiomas Pampa - LULC Preview Thumbnail
*/
...
// Brazilian Pampa - natural grassland, cropland and forest plantation
var region = ee.Geometry.Point([-55.0, -31.0]).buffer(20000).bounds();
