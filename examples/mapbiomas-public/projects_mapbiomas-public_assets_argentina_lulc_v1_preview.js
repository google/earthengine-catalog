/**
  MapBiomas Argentina - Land Use and Land Cover V3 - Preview Thumbnail
*/
...
// Buenos Aires province - representative Pampas grassland area in Argentina
var region = ee.Geometry.Point([-62.0, -36.0]).buffer(20000).bounds();
