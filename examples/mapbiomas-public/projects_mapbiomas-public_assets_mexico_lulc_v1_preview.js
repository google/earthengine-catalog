/**
  MapBiomas Mexico - LULC Preview Thumbnail
*/
...
// Yucatan peninsula - tropical dry forest, agriculture and urban area
var region = ee.Geometry.Point([-89.2, 20.7]).buffer(20000).bounds();
