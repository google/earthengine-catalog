/**
  MapBiomas Chile - Land Use and Land Cover V2 - Preview Thumbnail
*/
...
// Los Lagos region - representative temperate forest area in southern Chile
var region = ee.Geometry.Point([-72.5, -40.5]).buffer(20000).bounds();
