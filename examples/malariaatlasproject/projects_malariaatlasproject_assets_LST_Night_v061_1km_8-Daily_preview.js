var dataset = ee.ImageCollection('projects/malariaatlasproject/assets/LST_Night_v061/1km/8-Daily')
...
Map.setCenter(0, 0, 2);
Map.addLayer(means, visParams, '8-Daily LST Night: Malaria Atlas Project Gap-Filled Nighttime Land Surface Temperature');
