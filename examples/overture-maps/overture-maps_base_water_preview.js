...
var waterImage = water.reduceToImage({
  properties: [],
...
var waterImageVisualized = waterImage.visualize(waterVisParams);
...
var imageWithBackground = ee.ImageCollection([background, waterImageVisualized]).mosaic();
