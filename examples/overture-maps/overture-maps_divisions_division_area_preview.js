...
var divisionAreasImage = divisionAreas.reduceToImage({
  properties: [],
  reducer: ee.Reducer.count()
});

var divisionAreasVisParams = {
  min: 0,
  max: 10,
  palette: ['ffffff', '7b1fa2'],
  opacity: 0.8
};
var divisionAreasImageVisualized = divisionAreasImage.visualize(divisionAreasVisParams);
...
var imageWithBackground = ee.ImageCollection([background, divisionAreasImageVisualized]).mosaic();
