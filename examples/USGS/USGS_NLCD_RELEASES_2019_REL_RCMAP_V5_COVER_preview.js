...
var water_land = ee.Image('NOAA/NGDC/ETOPO1').select('bedrock').gt(0.0);

var background_palette = ['cadetblue', 'lightgray'];
var water_land_viz = {palette: background_palette};
var water_land_background = water_land.visualize({palette: background_palette});
...
var imageWithBackground = ee.ImageCollection([
  water_land_background, image]).mosaic();
