// TODO: Update the image collection ID with the public data catalog ID
var dataset = ee.ImageCollection('projects/openet/ensemble/conus/gridmet/monthly/v2_0')
...
Map.addLayer(et, visualization, 'OpenET Ensemble Monthly ET');
