...
var uncertainty = dataset.select('uncertainty_csr');
...
// Visualization parameters for uncertainty bands (typically positive values)
var uncertaintyVis = {
  min: 0.01,
  max: 0.02,
  palette: ['001137', '01abab', 'e7eb05', '620500']
...
Map.addLayer(uncertainty, uncertaintyVis, 'Uncertainty CSR');
